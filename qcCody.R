...
D <- readLipd("/Users/npm4/Dropbox/HoloceneLiPDLibrary/library030619/")
TS <- extractTs(D)
...
for(i in 1:length(toPull)){
  #see if the spreadsheet is empty
...
write_csv(out,path = "/Users/npm4/Dropbox/HoloceneLiPDLibrary/library030619/qcCody.csv")
