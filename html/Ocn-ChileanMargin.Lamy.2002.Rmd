---
title: "Ocn-ChileanMargin.Lamy.2002"
output: 
...
```
#Ocn-ChileanMargin.Lamy.2002

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-ChileanMargin.Lamy.2002.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Lamy, Frank;Rühlemann, Carsten;Hebbeln, Dierk;Wefer, Gerold
...
<p style="margin-left: 10px"><strong>pages: </strong>PA000727
...
<p style="margin-left: 10px"><strong>author: </strong>Lamy, F.
<p style="margin-left: 10px"><strong>citeKey: </strong>lamy2002httpswwwncdcnoaagovpaleostudy6242DataCitation
