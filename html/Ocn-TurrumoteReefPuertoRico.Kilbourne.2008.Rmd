---
title: "Ocn-TurrumoteReefPuertoRico.Kilbourne.2008"
output: 
...
```
#Ocn-TurrumoteReefPuertoRico.Kilbourne.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-TurrumoteReefPuertoRico.Kilbourne.2008.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>ftp://ftp.ncdc.noaa.gov/pub/data/paleo/coral/caribbean/turrumote2008.txt
...
<p style="margin-left: 10px"><strong>author: </strong>Kilbourne, K. H.;Quinn, T. M.;Webb, R.;Guilderson, T.;Nyberg, J.;Winter, A.
<p style="margin-left: 10px"><strong>citeKey: </strong>kilbourne2008paleoclimateproxyperspect
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>23
<p style="margin-left: 10px"><strong>pages: </strong>PA3220
<p style="margin-left: 10px"><strong>pubYear: </strong>2008
<p style="margin-left: 10px"><strong>title: </strong>Paleoclimate proxy perspective on Caribbean climate since the year 1751: Evidence of cooler temperatures and multidecadal variability
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/2008PA001598
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>citeKey: </strong>kilbourne2009httpswwwncdcnoaagovpaleostudy6117DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>17.93
<p style="margin-left: 0px"><strong>longitude: </strong>-67
<p style="margin-left: 0px"><strong>elevation: </strong>-5
<p style="margin-left: 0px"><strong>siteName: </strong>Turrumote Reef, Puerto Rico
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_099
...
<p style="margin-left: 20px"><strong>seasonality: </strong>-12 -11 -10 -9 -8 -7 1 2 3 4 5 6
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_100
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_101
