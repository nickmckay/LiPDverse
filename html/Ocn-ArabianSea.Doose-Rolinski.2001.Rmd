---
title: "Ocn-ArabianSea.Doose-Rolinski.2001"
output: 
...
```
#Ocn-ArabianSea.Doose-Rolinski.2001

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-ArabianSea.Doose-Rolinski.2001.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Doose-Rolinski, Heidi;Rogalla, Ulf;Scheeder, Georg;Lückge, Andreas;von Rad, Ulrich
<p style="margin-left: 10px"><strong>citeKey: </strong>doose2001highresolutiontemperature
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>16
<p style="margin-left: 10px"><strong>pages: </strong>358-367
...
<p style="margin-left: 10px"><strong>citeKey: </strong>doose2001httpdoipangaeade101594pangaea735717DataCitation
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_116
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>sea surface temperature
