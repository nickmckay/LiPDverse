---
title: "NAm-MtStHelens.Briffa.1996"
output: 
...
```
#NAm-MtStHelens.Briffa.1996

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](NAm-MtStHelens.Briffa.1996.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/2839
...
<p style="margin-left: 10px"><strong>citeKey: </strong>briffa1996httpswwwncdcnoaagovpaleostudy2839DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Mt. St. Helens
...
<details style="margin-left: 10px">
<summary>MXD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3436
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3421
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3422
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3423
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3424
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3425
...
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3426
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3427
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3428
...
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3429
...
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3430
...
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3431
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3432
...
<details style="margin-left: 10px">
<summary>sampleCount</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3433
<p style="margin-left: 10px"><strong>variableName: </strong>sampleCount
<p style="margin-left: 10px"><strong>units: </strong>count
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>segment</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3434
<p style="margin-left: 10px"><strong>variableName: </strong>segment
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3435
...
<details style="margin-left: 10px">
<summary>residual</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3437
<p style="margin-left: 10px"><strong>variableName: </strong>residual
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3438
<p style="margin-left: 10px"><strong>variableName: </strong>ARS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>corrs</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3439
<p style="margin-left: 10px"><strong>variableName: </strong>corrs
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>RBar</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3440
<p style="margin-left: 10px"><strong>variableName: </strong>RBar
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3441
<p style="margin-left: 10px"><strong>variableName: </strong>SD
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3442
<p style="margin-left: 10px"><strong>variableName: </strong>SE
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3443
<p style="margin-left: 10px"><strong>variableName: </strong>EPS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>core</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3444
<p style="margin-left: 10px"><strong>variableName: </strong>core
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
