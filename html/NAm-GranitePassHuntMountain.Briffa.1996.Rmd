---
title: "NAm-GranitePassHuntMountain.Briffa.1996"
output: 
...
```
#NAm-GranitePassHuntMountain.Briffa.1996

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](NAm-GranitePassHuntMountain.Briffa.1996.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/2820
...
<p style="margin-left: 10px"><strong>citeKey: </strong>briffa1996httpswwwncdcnoaagovpaleostudy2820DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>-107.9
<p style="margin-left: 0px"><strong>elevation: </strong>2820
<p style="margin-left: 0px"><strong>siteName: </strong>Granite Pass   Hunt Mountain
...
<details style="margin-left: 10px">
<summary>MXD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3676
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3661
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3662
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3663
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3664
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3665
...
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3666
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3667
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3668
...
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3669
...
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3670
...
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3671
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3672
...
<details style="margin-left: 10px">
<summary>sampleCount</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3673
<p style="margin-left: 10px"><strong>variableName: </strong>sampleCount
<p style="margin-left: 10px"><strong>units: </strong>count
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>segment</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3674
<p style="margin-left: 10px"><strong>variableName: </strong>segment
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3675
...
<details style="margin-left: 10px">
<summary>residual</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3677
<p style="margin-left: 10px"><strong>variableName: </strong>residual
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3678
<p style="margin-left: 10px"><strong>variableName: </strong>ARS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>corrs</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3679
<p style="margin-left: 10px"><strong>variableName: </strong>corrs
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>RBar</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3680
<p style="margin-left: 10px"><strong>variableName: </strong>RBar
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3681
<p style="margin-left: 10px"><strong>variableName: </strong>SD
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3682
<p style="margin-left: 10px"><strong>variableName: </strong>SE
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3683
<p style="margin-left: 10px"><strong>variableName: </strong>EPS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>core</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3684
<p style="margin-left: 10px"><strong>variableName: </strong>core
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
