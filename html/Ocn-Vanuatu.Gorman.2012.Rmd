...
```
#Ocn-Vanuatu.Gorman.2012

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Vanuatu.Gorman.2012.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Gorman, Meaghan K.;Quinn, Terrence M.;Taylor, Frederick W.;Partin, Judson W.;Cabioch, Guy;Austin, James A.;Pelletier, Bernard;Ballu, Valérie;Maes, Christophe;Saustrup, Steffen
<p style="margin-left: 10px"><strong>citeKey: </strong>gorman2012acoralbasedreconstruction
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>27
<p style="margin-left: 10px"><strong>pages: </strong>PA3226
...
<p style="margin-left: 10px"><strong>author: </strong>Gorman, M.K.
<p style="margin-left: 10px"><strong>citeKey: </strong>gorman2012httpswwwncdcnoaagovpaleostudy13439DataCitation
