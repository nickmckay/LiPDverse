---
title: "Ocn-MaloChannelEspirituSantoIsland.Kilbourne.2004"
output: 
...
```
#Ocn-MaloChannelEspirituSantoIsland.Kilbourne.2004

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-MaloChannelEspirituSantoIsland.Kilbourne.2004.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Kilbourne, K. Halimeda;Quinn, Terrence M.;Taylor, Frederick W.;Delcroix, Thierry;Gouriou, Yves
<p style="margin-left: 10px"><strong>citeKey: </strong>kilbourne2004elniosouthernoscillationr
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>19
<p style="margin-left: 10px"><strong>pages: </strong>PA4002
<p style="margin-left: 10px"><strong>pubYear: </strong>2004
<p style="margin-left: 10px"><strong>title: </strong>El Niño-Southern Oscillation-related salinity variations recorded in the skeletal geochemistry of a Porites coral from Espiritu Santo, Vanuatu
...
<p style="margin-left: 10px"><strong>citeKey: </strong>kilbourne2007httpswwwncdcnoaagovpaleostudy1925DataCitation
