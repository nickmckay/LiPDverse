...
```
#Asi-MTASSP.Davi.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MTASSP.Davi.2013.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/3060
...
<p style="margin-left: 10px"><strong>author: </strong>Davi, N.K.
<p style="margin-left: 10px"><strong>citeKey: </strong>davi2003httpswwwncdcnoaagovpaleostudy3060DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>142.55
<p style="margin-left: 0px"><strong>elevation: </strong>3730
<p style="margin-left: 0px"><strong>siteName: </strong>JAPA008
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_108
