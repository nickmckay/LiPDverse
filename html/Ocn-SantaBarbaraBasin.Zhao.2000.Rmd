---
title: "Ocn-SantaBarbaraBasin.Zhao.2000"
output: 
...
```
#Ocn-SantaBarbaraBasin.Zhao.2000

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-SantaBarbaraBasin.Zhao.2000.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>http://www.ncdc.noaa.gov/paleo/study/17755
...
<p style="margin-left: 10px"><strong>author: </strong>Zhao, Meixun;Eglinton, Geoffrey;Read, Gareth;Schimmelmann, Arndt
<p style="margin-left: 10px"><strong>citeKey: </strong>zhao2000analkenoneu37kquasiannual
<p style="margin-left: 10px"><strong>journal: </strong>Organic Geochemistry
<p style="margin-left: 10px"><strong>volume: </strong>31
<p style="margin-left: 10px"><strong>pages: </strong>903-917
<p style="margin-left: 10px"><strong>pubYear: </strong>2000
<p style="margin-left: 10px"><strong>title: </strong>An alkenone (U37K′) quasi-annual sea surface temperature record (A.D. 1440 to 1940) using varved sediments from the Santa Barbara Basin
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/S0146-6380(00)00034-6
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>citeKey: </strong>zhao2015httpswwwncdcnoaagovpaleostudy17755DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>34.23
<p style="margin-left: 0px"><strong>longitude: </strong>-120.02
<p style="margin-left: 0px"><strong>elevation: </strong>-590
<p style="margin-left: 0px"><strong>siteName: </strong>Santa Barbara Basin (California)
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_183
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_184
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_185
<p style="margin-left: 10px"><strong>variableName: </strong>core
<p style="margin-left: 10px"><strong>description: </strong>ID number of core used to generate composite record
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
