---
title: "Ocn-WesternSvalbard.Spielhagen.2011"
output: 
...
```
#Ocn-WesternSvalbard.Spielhagen.2011

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-WesternSvalbard.Spielhagen.2011.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>http://doi.pangaea.de/10.1594/PANGAEA.755092
...
<p style="margin-left: 10px"><strong>author: </strong>Spielhagen, R. F.;Werner, K.;Sorensen, S. A.;Zamelczyk, K.;Kandiano, E.;Budeus, G.;Husum, K.;Marchitto, T. M.;Hald, M.
<p style="margin-left: 10px"><strong>citeKey: </strong>spielhagen2011enhancedmodernheattransfe
<p style="margin-left: 10px"><strong>journal: </strong>Science
<p style="margin-left: 10px"><strong>volume: </strong>331
<p style="margin-left: 10px"><strong>pages: </strong>450-453
<p style="margin-left: 10px"><strong>pubYear: </strong>2011
<p style="margin-left: 10px"><strong>title: </strong>Enhanced modern heat transfer to the Arctic by warm Atlantic water
<p style="margin-left: 10px"><strong>DOI: </strong>10.1126/science.1197397
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>author: </strong>Spielhagen, R.F.
<p style="margin-left: 10px"><strong>citeKey: </strong>spielhagen2011httpdoipangaeade101594pangaea755092DataCitation
<p style="margin-left: 10px"><strong>title: </strong>PANGAEA
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>78.91
<p style="margin-left: 0px"><strong>longitude: </strong>6.77
<p style="margin-left: 0px"><strong>elevation: </strong>-1491
<p style="margin-left: 0px"><strong>siteName: </strong>Western Svalbard
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_007
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_009
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
