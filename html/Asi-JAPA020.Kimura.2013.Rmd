...
```
#Asi-JAPA020.Kimura.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-JAPA020.Kimura.2013.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/15215
...
<p style="margin-left: 10px"><strong>author: </strong>Kimura, K.
<p style="margin-left: 10px"><strong>citeKey: </strong>kimura2013httpswwwncdcnoaagovpaleostudy15215DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>130.5
<p style="margin-left: 0px"><strong>elevation: </strong>3800
<p style="margin-left: 0px"><strong>siteName: </strong>JAPA020
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_111
