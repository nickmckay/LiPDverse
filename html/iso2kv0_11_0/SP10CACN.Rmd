...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP10CACN.lpd)
            

[Download data only (csv)](SP10CACN.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT93a57cb515
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATddf73663d5
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT75239c3092
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT29bbed486c
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
<p style="margin-left: 10px"><strong>description: </strong>depth
</details>
