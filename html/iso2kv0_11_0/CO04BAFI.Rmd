...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO04BAFI.lpd)
            

[Download data only (csv)](CO04BAFI.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT3d77acceab
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT3e7e72dbc4
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT2ce6761c47
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT41704fb11c
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
<p style="margin-left: 10px"><strong>description: </strong>depth
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT034aca7b9b
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
