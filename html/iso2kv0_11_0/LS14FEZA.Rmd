...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/LS14FEZA.lpd)
            

[Download data only (csv)](LS14FEZA.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT0ee6aa23ee
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATe175dfba95
...
<details style="margin-left: 10px">
<summary>dD (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LS14FEZA01A
<p style="margin-left: 10px"><strong>variableName: </strong>dD
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>biomarkers
<details>
