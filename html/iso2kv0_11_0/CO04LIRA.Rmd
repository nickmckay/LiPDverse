...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO04LIRA.lpd)
            

[Download data only (csv)](CO04LIRA.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATd54b29aec2
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATb66e725012
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT9bc8095ce7
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
