...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC08VISV.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC08VISV.lpd)
            

[Download data only (csv)](IC08VISV.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Vimeux
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/2007JD009502
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-46.58
<p style="margin-left: 0px"><strong>longitude: </strong>-73.32
<p style="margin-left: 0px"><strong>elevation: </strong>3747
<p style="margin-left: 0px"><strong>siteName: </strong>San Valentin
</details>
<details open>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT1f9cdde02b
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC08VISV01A
...
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>chronology based on annual layer counting, bomb reference horizon
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong>5-Jan
