...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](SP12LAMX.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP12LAMX.lpd)
            

[Download data only (csv)](SP12LAMX.csv)
...
<p style="margin-left: 10px"><strong>DOI: </strong>10.1130/G32471.1
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATd6cc5fd959
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATa95ba7efd5
...
<p style="margin-left: 10px"><strong>TSid: </strong>SP12LAMX01A
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>(1) The most recent stalagmite ?18O values are anticorrelated with Basin of Mexico precipitation, showing our record to be a robust proxy for rainfall amount. (2) Smothed ?18O data and Tacubaya wet season (May through November, MJJASON, comprising 95% of the annual total) rainfall (1880?2010 CE) is strongly anticorrelated. (3) Observational studies of tropical rainfall
...
<p style="margin-left: 20px"><strong>variableDetail: </strong>Summer monsoon rainfall amount
...
<p style="margin-left: 20px"><strong>integrationTime: </strong>9 yr smoothed rainfall and ?18O data (1878?1988 CE) are correlated at r=-0.89, suggesting a a ca. 9yr transit time (the chronology was adjusted accordingly)
