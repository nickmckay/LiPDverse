...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO04INMI.lpd)
            

[Download data only (csv)](CO04INMI.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT9428837404
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATc62895feff
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>oxygen isotope record mainly reflects the seasonal SST cycle of 1â€“2 C at this location
