...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP03BMIL.lpd)
            

[Download data only (csv)](SP03BMIL.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT78fbf302bc
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATec32ecc339
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>The modern analog supporting the association of enhanced rainfall with minimum speleothem Î´18O values is the present-day relationship between decreasing rainfall Î´18O and increasing annual rainfall amount (Fig. 4).
