...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](CO17MUMA.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO17MUMA.lpd)
            

[Download data only (csv)](CO17MUMA.csv)
...
<details style="margin-left: 10px">
<summary>d18O (permill vpdb) [1-1]</summary>
...
### d18O (permill vpdb) [1-1]
```{r}
plotCol(thisTS,ind = 2)
```

### d18O (permill vpdb) [1-2]
```{r}
