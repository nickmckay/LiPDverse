...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC06VID3.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC06VID3.lpd)
            

[Download data only (csv)](IC06VID3.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC06VID301A
