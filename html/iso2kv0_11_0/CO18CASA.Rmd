...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](CO18CASA.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO18CASA.lpd)
            

[Download data only (csv)](CO18CASA.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB23db2e14
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>5 year steps
</details>
<details style="margin-left: 10px">
