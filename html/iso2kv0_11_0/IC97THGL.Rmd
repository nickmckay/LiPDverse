...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC97THGL.lpd)
            

[Download data only (csv)](IC97THGL.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT27385312db
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD at the top of the 10 year interval
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MAT0c4ed65265
...
<p style="margin-left: 20px"><strong>seasonality: </strong>annual (but 70-80% of annual precip during summer monsoon)
