...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO00COKY.lpd)
            

[Download data only (csv)](CO00COKY.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATac63aaf979
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>The coral 18O record from this site re- flects primarily SST; a linear regression of coral 18O versus SST yields a slope of0.24 per mil (â€°) 18O per 1Â°C, explaining 47% of the SST variance (20).
