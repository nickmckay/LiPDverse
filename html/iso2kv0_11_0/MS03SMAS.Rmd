...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](MS03SMAS.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/MS03SMAS.lpd)
            

[Download data only (csv)](MS03SMAS.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Staubwasser, M.
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/2002GL016822
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>24.62
<p style="margin-left: 0px"><strong>longitude: </strong>65.98
<p style="margin-left: 0px"><strong>elevation: </strong>-316
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDdd8c4ff11
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
<p style="margin-left: 10px"><strong>description: </strong>corrected depth; core depth minus event deposits
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MS03SMAS01
