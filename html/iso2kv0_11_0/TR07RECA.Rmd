...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/TR07RECA.lpd)
            

[Download data only (csv)](TR07RECA.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATad36c816e2
...
<p style="margin-left: 20px"><strong>seasonality: </strong>P_amount (June), temperature (July, Aug)
</details>
<details style="margin-left: 20px">
<summary>2</summary>
