...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO97CHSY.lpd)
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>At  the  Seychelles,  however, one would expect the seasonal temperature variability (of more than 2ï¿½C) to dominate the nearly constant d18O of seawater
