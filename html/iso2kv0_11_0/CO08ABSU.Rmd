...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](CO08ABSU.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO08ABSU.lpd)
            

[Download data only (csv)](CO08ABSU.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Abram, N.J., M.K. Gagan, J.E. Cole, W.S. Hantoro, and M. Mudelsee
<p style="margin-left: 10px"><strong>citeKey: </strong>abram2008recent
...
<p style="margin-left: 10px"><strong>title: </strong>Ocean2kHR-IndianMentawaiAbram2008
...
<p style="margin-left: 0px"><strong>siteName: </strong>Mantawai Islands, West Sumatra, Indonesia
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT8333f8f3fc
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>IOD  upwelling  cools  the ambient  SST  and  decreases  rainfall,  both  of  which  increase coral d18O.
...
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>annual cycles of d18O, verified using annual growth bands
