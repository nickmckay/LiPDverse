...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/TR06TRBO.lpd)
            

[Download data only (csv)](TR06TRBO.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT91b2d06d87
...
<p style="margin-left: 20px"><strong>seasonality: </strong>October previous year to September current year
