...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO99DRGB.lpd)
            

[Download data only (csv)](CO99DRGB.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT006ef56891
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT5c847f27aa
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Oxygen isotope records in banded corals( ï¿½!80) are mainly controlled by water composition (i.e., seawater salinity) and sea surface temperature (SST) at the time of accretion
