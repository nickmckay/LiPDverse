...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO14ZIMG.lpd)
            

[Download data only (csv)](CO14ZIMG.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD9ad6b867
...
<details style="margin-left: 20px">
<summary>4</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Salinity_water (mostly P-E)
<p style="margin-left: 20px"><strong>coefficient: </strong>NA
<p style="margin-left: 20px"><strong>fraction: </strong>NA
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDa3ff45fc
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
