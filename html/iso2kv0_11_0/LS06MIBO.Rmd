...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/LS06MIBO.lpd)
            

[Download data only (csv)](LS06MIBO.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Mischke, S. , WÃ¼nnemann, B.
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT71c5466a68
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATe778de7ac5
