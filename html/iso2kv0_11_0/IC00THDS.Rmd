...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC00THDS.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC00THDS.lpd)
            

[Download data only (csv)](IC00THDS.csv)
...
<p style="margin-left: 10px"><strong>DOI: </strong>10.1126/science.289.5486.1916
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>28.38
<p style="margin-left: 0px"><strong>longitude: </strong>85.72
<p style="margin-left: 0px"><strong>elevation: </strong>7200
<p style="margin-left: 0px"><strong>siteName: </strong>Dasuopu
</details>
<details open>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC00THDS03B
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>correlation to meteorological data, ("...these data provide qualitative support for the hypothesis that temperature, not the amount effect, is the dominant process controlling d18O over the Tibetan Plateau.")
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Yao, T., Thompson, L. G., Mosley-Thompson, E., Zhihong, Y., Xingping, Z., and Lin, P.-N.: 1996,Climatological Significance of Î´18O in North Tibetan Ice Cores, J. Geophys. Res. 101, 29531â€“29537
<p style="margin-left: 20px"><strong>direction: </strong>positive
...
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong>1 after 1440, 5 before 1440
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC00THDS03Ay
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC00THDS03A
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>d18O of glacier ice
<details>
...
<p style="margin-left: 20px"><strong>integrationTime: </strong>1
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>age model based on beta activity and counting of annual layers (seasonal variations of stable isotopes)
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong>1 to 15
<p style="margin-left: 20px"><strong>integrationTimeUncertaintyType: </strong>chronology
<p style="margin-left: 20px"><strong>integrationTimeUnits: </strong>years
<p style="margin-left: 20px"><strong>mathematicalRelation: </strong>linear
<p style="margin-left: 20px"><strong>rank: </strong>1
