...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LS07ANMA.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/LS07ANMA.lpd)
            

[Download data only (csv)](LS07ANMA.csv)
...
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.quascirev.2006.04.011
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT7ad84f8db8
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATf01b198877
...
<p style="margin-left: 10px"><strong>TSid: </strong>LS07ANMA
...
<p style="margin-left: 20px"><strong>variableDetail: </strong>effective moisture occurred simultaneously with changes in Aleutian Low circulation
...
<p style="margin-left: 20px"><strong>integrationTime: </strong>100
...
<details style="margin-left: 20px">
<summary>3</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Temperature fractionations between calcite and lake water were considered and are thought to be minor (0.25%/1C).
<p style="margin-left: 20px"><strong>inferredMaterial: </strong>lake water
<p style="margin-left: 20px"><strong>integrationTime: </strong>100
<p style="margin-left: 20px"><strong>integrationTimeUncertaintyType: </strong>chronological
<p style="margin-left: 20px"><strong>integrationTimeUnits: </strong>years
