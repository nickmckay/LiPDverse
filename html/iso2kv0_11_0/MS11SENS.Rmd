...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](MS11SENS.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/MS11SENS.lpd)
            

[Download data only (csv)](MS11SENS.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Sejrup, H.P.
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.quascirev.2011.07.025
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>63.76
<p style="margin-left: 0px"><strong>longitude: </strong>5.25
<p style="margin-left: 0px"><strong>elevation: </strong>-875
<p style="margin-left: 0px"><strong>siteName: </strong>Norwegian Sea
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MAT34dc3c9f88
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT72174380d3
...
<p style="margin-left: 10px"><strong>TSid: </strong>MS11SENS01
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>salinity/d18Ow influence thought to be minor
<p style="margin-left: 20px"><strong>interpDirection: </strong>decrease/increase
<p style="margin-left: 20px"><strong>scope: </strong>climate
<p style="margin-left: 20px"><strong>seasonality: </strong>summer (JAS)
<p style="margin-left: 20px"><strong>variable: </strong>temperature/d18Osw
<p style="margin-left: 20px"><strong>variableDetail: </strong>sub surface (~50 m)
...
<p style="margin-left: 20px"><strong>equilibriumEvidence: </strong>NaN
<p style="margin-left: 20px"><strong>fraction: </strong>NaN
<p style="margin-left: 20px"><strong>inferredMaterial: </strong>calcite, sub surface
<p style="margin-left: 20px"><strong>integrationTime: </strong>NaN
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>NaN
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong>NaN
<p style="margin-left: 20px"><strong>integrationTimeUncertaintyType: </strong>NaN
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD6c1fc0ed6
<p style="margin-left: 10px"><strong>variableName: </strong>core
<p style="margin-left: 10px"><strong>description: </strong>P1003MC or P1003SC in splice
<details>
<summary>interpretation</summary>
<details style="margin-left: 20px">
<summary>1</summary>
