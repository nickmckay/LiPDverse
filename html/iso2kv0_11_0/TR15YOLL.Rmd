...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/TR15YOLL.lpd)
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Each of the individual Î´18O series has a significant negative correlation (p < 0.001) with the summer (Juneâ€“August) EWP
