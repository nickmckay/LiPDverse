...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/MS06DLGS.lpd)
            

[Download data only (csv)](MS06DLGS.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATb7d7ba1947
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB27177a55
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPDc07746c5
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
...
<details style="margin-left: 10px">
<summary>d18O (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MS06DLGS01a
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
...
<details style="margin-left: 10px">
<summary>Mg_Ca (mmol/mol)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPD8c7da1f7
<p style="margin-left: 10px"><strong>variableName: </strong>Mg_Ca
<p style="margin-left: 10px"><strong>units: </strong>mmol/mol
<p style="margin-left: 10px"><strong>description: </strong>native Mg/Ca ratio from which SST was calculated; values are from Lunds "Avg Mg/Ca" column and are in units of mmol/mol; note that in original source, there are also MgCa estimates for std. dev & std. error
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
