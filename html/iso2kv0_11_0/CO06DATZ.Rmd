...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO06DATZ.lpd)
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>The coral captures approximately 60% of the full range of annual SST (4ï¿½C = 0.88%).
