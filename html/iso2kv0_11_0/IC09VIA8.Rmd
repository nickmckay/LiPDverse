...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC09VIA8.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC09VIA8.lpd)
            

[Download data only (csv)](IC09VIA8.csv)
...
<p style="margin-left: 0px"><strong>siteName: </strong>Agassiz A84-A87
</details>
<details open>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC09VIA800A
