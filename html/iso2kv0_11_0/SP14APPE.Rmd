...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP14APPE.lpd)
            

[Download data only (csv)](SP14APPE.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Apa̩stegui, J.
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT7fa47a91bd
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATab160c351c
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT2cf6c2d82a
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT99c4f77807
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
<p style="margin-left: 10px"><strong>description: </strong>depth
</details>
