...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC02HEWD.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC02HEWD.lpd)
            

[Download data only (csv)](IC02HEWD.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Henderson
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>81
<p style="margin-left: 0px"><strong>longitude: </strong>64
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD83e71d02
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC02HEWD01A
...
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>age model based on reference horizons, counting of annual layers
