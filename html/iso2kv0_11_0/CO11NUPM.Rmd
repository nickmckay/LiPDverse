...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO11NUPM.lpd)
            

[Download data only (csv)](CO11NUPM.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATeace3b3bb7
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATdc371275db
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
