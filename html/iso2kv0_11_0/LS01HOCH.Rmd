...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LS01HOCH.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/LS01HOCH.lpd)
            

[Download data only (csv)](LS01HOCH.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Hodell, D. A., Brenner, M., Curtis, J., Guilderson, T.
<p style="margin-left: 10px"><strong>journal: </strong>Science
<p style="margin-left: 10px"><strong>volume: </strong>292
<p style="margin-left: 10px"><strong>pages: </strong>13671370
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>title: </strong>Solar Forcing of Drought Frequency in the Maya Lowlands
<p style="margin-left: 10px"><strong>DOI: </strong>10.1126/science.1057759
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATae2887b82a
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATc97475c57e
...
<p style="margin-left: 10px"><strong>TSid: </strong>LS01HOCH
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>The d18O record from Chichancanab generally supports our E/P inferences based on the S record
