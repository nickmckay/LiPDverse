...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP13SLNA.lpd)
            

[Download data only (csv)](SP13SLNA.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT36032ab0af
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATa007254f46
...
<p style="margin-left: 20px"><strong>variable: </strong>Precipitation_amount, humidity
...
<p style="margin-left: 20px"><strong>direction: </strong>negative (more rainfall, more negative d18O and d13C)
</details>
<details style="margin-left: 20px">
<summary>2</summary>
