...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC93BAGI.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC93BAGI.lpd)
            

[Download data only (csv)](IC93BAGI.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Barlow
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/93GL03305
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>72.59
<p style="margin-left: 0px"><strong>longitude: </strong>-38.46
<p style="margin-left: 0px"><strong>elevation: </strong>3200
<p style="margin-left: 0px"><strong>siteName: </strong>GISP2-B
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPD262db1c3
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD1afc9547
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC93BAGI01A
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC93BAGI02Ay
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC93BAGI02Ad
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>m
<p style="margin-left: 10px"><strong>description: </strong>depth
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC93BAGI02A
<p style="margin-left: 10px"><strong>variableName: </strong>dD
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>dD of glacier ice
<details>
