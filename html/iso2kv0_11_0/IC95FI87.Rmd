...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC95FI87.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC95FI87.lpd)
            

[Download data only (csv)](IC95FI87.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Fisher
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1177/095968369500500103
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD2e054fdc
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDecd5ba45
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC95FI8701A
...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Correlation with nearby Halley Station meteorological data 5thompson et al, 1994, fig 4)
<p style="margin-left: 20px"><strong>direction: </strong>positive
...
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong>10-Jan
