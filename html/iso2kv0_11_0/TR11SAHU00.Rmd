...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/TR11SAHU00.lpd)
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Instrumental calibration. A negative correlation between Î´18O of precipitation and the amount of precipitation is observed in tropical regions including the Himalaya, which is termed as the â€˜amount effectâ€™ (AraguÃ¡s-AraguÃ¡s et al., 1998; Dansgaard, 1964; Yadava and Ramesh, 2005).
