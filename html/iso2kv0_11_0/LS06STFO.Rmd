...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LS06STFO.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/LS06STFO.lpd)
            

[Download data only (csv)](LS06STFO.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Stevens, Lora R. , Stone, Jeffery R. , Campbell, Josh , Fritz, Sherilyn C.
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>65
<p style="margin-left: 10px"><strong>pages: </strong>-10
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>title: </strong>A 2200-yr record of hydrologic variability from Foy Lake, Montana, USA, inferred from diatom and geochemical data
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.yqres.2005.08.024
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>siteName: </strong>Foy
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MATd8098e0fdb
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATb35e4d829b
...
<p style="margin-left: 10px"><strong>TSid: </strong>LS06STFO
