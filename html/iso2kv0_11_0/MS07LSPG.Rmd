...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/MS07LSPG.lpd)
            

[Download data only (csv)](MS07LSPG.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATa6d7a420eb
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD248cb8ef2
<p style="margin-left: 10px"><strong>variableName: </strong>year
<p style="margin-left: 10px"><strong>units: </strong>AD
<p style="margin-left: 10px"><strong>description: </strong>Year AD
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD248cb8ef2j
...
<details style="margin-left: 10px">
<summary>d18O (permil) [1-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MS07LSPG01a
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
