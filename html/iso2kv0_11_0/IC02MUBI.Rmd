...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC02MUBI.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/IC02MUBI.lpd)
            

[Download data only (csv)](IC02MUBI.csv)
...
<p style="margin-left: 0px"><strong>siteName: </strong>Berkner Island (South) B25
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>MAT378b2eff6c
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC02MUBI01A
