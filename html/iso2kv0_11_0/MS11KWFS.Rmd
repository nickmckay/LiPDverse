...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](MS11KWFS.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/MS11KWFS.lpd)
            

[Download data only (csv)](MS11KWFS.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Werner, K.
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.palaeo.2011.05.030
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>elevation: </strong>-1490.5
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATc0ebe08901
...
<p style="margin-left: 10px"><strong>TSid: </strong>MATf572b058f7
...
<p style="margin-left: 10px"><strong>TSid: </strong>MS11KWFS01
