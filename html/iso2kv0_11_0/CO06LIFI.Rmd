...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](CO06LIFI.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/CO06LIFI.lpd)
            

[Download data only (csv)](CO06LIFI.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Linsley, B.K. , A. Kaplan, Y. Gouriou, J. Salinger, P.B. deMenocal, G.M. Wellington, S.S. Howe
<p style="margin-left: 10px"><strong>citeKey: </strong>linsley2006tracking
...
<p style="margin-left: 10px"><strong>title: </strong>Ocean2kHR-PacificLinsley2006FijiAB
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT742e2c516d
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_156
