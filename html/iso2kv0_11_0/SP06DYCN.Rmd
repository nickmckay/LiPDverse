...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/iso2kv0_11_0/SP06DYCN.lpd)
            

[Download data only (csv)](SP06DYCN.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>MAT6b75ac3f3a
...
<p style="margin-left: 20px"><strong>variableDetail: </strong>East Asian Monsoon Strength; more negative values of d18O are interpreted as indicative of increased monsoon strength
