...
```
#Asi-MQDXJP.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MQDXJP.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>99.67
<p style="margin-left: 0px"><strong>elevation: </strong>500
<p style="margin-left: 0px"><strong>siteName: </strong>MQDXJP
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_053
