---
title: "Ocn-GingerbreadsBahamas.Saenger.2009"
output: 
...
```
#Ocn-GingerbreadsBahamas.Saenger.2009

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-GingerbreadsBahamas.Saenger.2009.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/16440
...
<p style="margin-left: 10px"><strong>author: </strong>Saenger, Casey;Cohen, Anne L.;Oppo, Delia W.;Halley, Robert B.;Carilli, Jessica E.
<p style="margin-left: 10px"><strong>citeKey: </strong>saenger2009surfacetemperaturetrendsa
<p style="margin-left: 10px"><strong>journal: </strong>Nature Geoscience
<p style="margin-left: 10px"><strong>volume: </strong>2
<p style="margin-left: 10px"><strong>pages: </strong>492-495
<p style="margin-left: 10px"><strong>pubYear: </strong>2009
<p style="margin-left: 10px"><strong>title: </strong>Surface-temperature trends and variability in the low-latitude North Atlantic since 1552
<p style="margin-left: 10px"><strong>DOI: </strong>10.1038/ngeo552
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>citeKey: </strong>saenger2009httpswwwncdcnoaagovpaleostudy16440DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>-78.62
<p style="margin-left: 0px"><strong>elevation: </strong>-4
<p style="margin-left: 0px"><strong>siteName: </strong>Gingerbreads Bahamas
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_130
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>annual growth anomaly calibration to SST
<p style="margin-left: 20px"><strong>interpDirection: </strong>negative
<p style="margin-left: 20px"><strong>scope: </strong>climate
<p style="margin-left: 20px"><strong>seasonality: </strong>-12 -11 -10 -9 1 2 3 4 5 6 7 8
