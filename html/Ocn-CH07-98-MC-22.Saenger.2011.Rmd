---
title: "Ocn-CH07-98-MC-22.Saenger.2011"
output: 
...
```
#Ocn-CH07-98-MC-22.Saenger.2011

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-CH07-98-MC-22.Saenger.2011.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Saenger, Casey;Came, Rosemarie E.;Oppo, Delia W.;Keigwin, Lloyd D.;Cohen, Anne L.
<p style="margin-left: 10px"><strong>citeKey: </strong>saenger2011regionalclimatevariabilit
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>26
<p style="margin-left: 10px"><strong>pages: </strong>PA2206
...
<p style="margin-left: 10px"><strong>citeKey: </strong>saenger2011httpswwwncdcnoaagovpaleostudy11816DataCitation
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>32.784
<p style="margin-left: 0px"><strong>longitude: </strong>-76.276
<p style="margin-left: 0px"><strong>elevation: </strong>-1895
<p style="margin-left: 0px"><strong>siteName: </strong>CH07-98-MC-22, Carolina Slope, western North Atlantic
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDa03ec713
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPD09e5a770
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD0fd7fc82
<p style="margin-left: 10px"><strong>variableName: </strong>Mg_Ca
<p style="margin-left: 10px"><strong>description: </strong>native Mg/Ca ratio from which SST was calculated; values are from foram G. ruber, and are in units of mmol/mol
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>Mg_Ca</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPDde87f63d
<p style="margin-left: 10px"><strong>variableName: </strong>Mg_Ca
<p style="margin-left: 10px"><strong>description: </strong>native Mg/Ca ratio from which SST was calculated; values are from foram G. ruber, and are in units of mmol/mol
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
