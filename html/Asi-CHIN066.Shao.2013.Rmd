...
```
#Asi-CHIN066.Shao.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-CHIN066.Shao.2013.lpd)
...
<p style="margin-left: 0px"><strong>siteName: </strong>CHIN066
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_100
