...
<p style="margin-left: 10px"><strong>author: </strong>c("Schefuß, Enno", "Schouten, Stefan", "Schneider, Ralph R.")
...
<p style="margin-left: 10px"><strong>author: </strong>c("Weijers, Johan W.H.", "Schouten, Stefan", "Schefuß, Enno", "Schneider, Ralph R.", "Sinninghe Damsté, Jaap S.")
