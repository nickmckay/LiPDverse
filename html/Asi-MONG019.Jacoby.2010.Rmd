...
```
#Asi-MONG019.Jacoby.2010

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MONG019.Jacoby.2010.lpd)
...
<p style="margin-left: 0px"><strong>siteName: </strong>MONG019
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_143
