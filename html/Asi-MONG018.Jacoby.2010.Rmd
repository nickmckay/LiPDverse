...
```
#Asi-MONG018.Jacoby.2010

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MONG018.Jacoby.2010.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>90.98
<p style="margin-left: 0px"><strong>elevation: </strong>1300
<p style="margin-left: 0px"><strong>siteName: </strong>MONG018
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_142
