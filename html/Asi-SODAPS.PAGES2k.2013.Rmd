...
```
#Asi-SODAPS.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-SODAPS.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>98.93
<p style="margin-left: 0px"><strong>elevation: </strong>2500
<p style="margin-left: 0px"><strong>siteName: </strong>SODAPS
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_155
