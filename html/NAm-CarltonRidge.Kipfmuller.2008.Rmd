---
title: "NAm-CarltonRidge.Kipfmuller.2008"
output: 
...
```
#NAm-CarltonRidge.Kipfmuller.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](NAm-CarltonRidge.Kipfmuller.2008.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Kipfmueller, Kurt F.
<p style="margin-left: 10px"><strong>citeKey: </strong>kipfmueller2008reconstructedsummertemper
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>70
<p style="margin-left: 10px"><strong>pages: </strong>173-187
<p style="margin-left: 10px"><strong>pubYear: </strong>2008
<p style="margin-left: 10px"><strong>title: </strong>Reconstructed summer temperature in the northern Rocky Mountains wilderness, USA
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.yqres.2008.04.003
</details>
<details style="margin-left: 10px">
<summary>pub2</summary>
<p style="margin-left: 10px"><strong>author: </strong>Kipfmuller, K.
<p style="margin-left: 10px"><strong>citeKey: </strong>kipfmuller0thisstudyDataCitation
<p style="margin-left: 10px"><strong>title: </strong>This study
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>46.7
<p style="margin-left: 0px"><strong>longitude: </strong>-114.2
<p style="margin-left: 0px"><strong>elevation: </strong>2614
<p style="margin-left: 0px"><strong>siteName: </strong>Carlton Ridge
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_004
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_001
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_002
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_003
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_005
...
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_006
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_007
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_008
...
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_009
...
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_010
...
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_011
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_012
