---
title: "Ocn-DryTortugasA.Lund.2006"
output: 
...
```
#Ocn-DryTortugasA.Lund.2006

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-DryTortugasA.Lund.2006.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Lund, David C.;Curry, William
<p style="margin-left: 10px"><strong>citeKey: </strong>lund2006floridacurrentsurfacetemp
...
<p style="margin-left: 10px"><strong>author: </strong>Lund, D.C.
<p style="margin-left: 10px"><strong>citeKey: </strong>lund2007httpswwwncdcnoaagovpaleostudy5968DataCitation
