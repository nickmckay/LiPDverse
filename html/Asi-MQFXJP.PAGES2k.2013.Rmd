...
```
#Asi-MQFXJP.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MQFXJP.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>99.68
<p style="margin-left: 0px"><strong>elevation: </strong>700
<p style="margin-left: 0px"><strong>siteName: </strong>MQFXJP
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_054
