---
title: "Ocn-LaingIslandPapuaNewGuinea.Tudhope.2001"
output: 
...
```
#Ocn-LaingIslandPapuaNewGuinea.Tudhope.2001

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-LaingIslandPapuaNewGuinea.Tudhope.2001.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Tudhope, A.W.;C.P. Chilcott;M.T. McCulloch;E.R. Cook;J. Chappell;R.M. Ellam;D.W. Lea;J.M Lough;G.B. Shimmield
<p style="margin-left: 10px"><strong>citeKey: </strong>tudhope2001variabilityintheelninosou
<p style="margin-left: 10px"><strong>journal: </strong>Science
<p style="margin-left: 10px"><strong>volume: </strong>291
<p style="margin-left: 10px"><strong>pages: </strong>1511-1517
...
<p style="margin-left: 10px"><strong>citeKey: </strong>tudhope2001httpswwwncdcnoaagovpaleostudy1866DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-4.15
<p style="margin-left: 0px"><strong>longitude: </strong>144.8833
<p style="margin-left: 0px"><strong>elevation: </strong>-3
<p style="margin-left: 0px"><strong>siteName: </strong>Laing Island, Papua New Guinea
