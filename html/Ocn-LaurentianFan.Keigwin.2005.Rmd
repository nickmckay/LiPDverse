---
title: "Ocn-LaurentianFan.Keigwin.2005"
output: 
...
```
#Ocn-LaurentianFan.Keigwin.2005

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-LaurentianFan.Keigwin.2005.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Keigwin, L. D.;Sachs, J. P.;Rosenthal, Y.;Boyle, E. A.
<p style="margin-left: 10px"><strong>citeKey: </strong>keigwin2005the8200yearbpeventinthesl
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>20
<p style="margin-left: 10px"><strong>pages: </strong>PA2003
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_030
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_032
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
