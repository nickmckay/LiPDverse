...
```
#Asi-NEPA014.Krusic.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-NEPA014.Krusic.2013.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/3771
...
<p style="margin-left: 10px"><strong>citeKey: </strong>krusic2002httpswwwncdcnoaagovpaleostudy3771DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>86.28
<p style="margin-left: 0px"><strong>elevation: </strong>3400
<p style="margin-left: 0px"><strong>siteName: </strong>NEPA014
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_169
