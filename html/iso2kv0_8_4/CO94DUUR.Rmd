...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](CO94DUUR.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/1850
<p style="margin-left: 0px"><strong>lipdVersion: </strong>1.3
<p style="margin-left: 0px"><strong>dataContributor: </strong>KJA, VE
</details>
<details>
<summary>pub</summary>
<details style="margin-left: 10px">
<summary>pub1</summary>
<p style="margin-left: 10px"><strong>author: </strong>Dunbar, R.B., G. M. Wellington, M. W. Colgan, P. W. Glynn 
<p style="margin-left: 10px"><strong>citeKey: </strong>dunbar1994eastern
...
<p style="margin-left: 10px"><strong>title: </strong>Eastern Pacific sea surface temperature since 1600 A.D.: The ? 18 O record of climate variability in Gal�pagos Corals
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/93PA03501
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>author: </strong>Dunbar, R.B.
<p style="margin-left: 10px"><strong>citeKey: </strong>dunbar1994ocean2khrDataCitation
<p style="margin-left: 10px"><strong>title: </strong>Ocean2kHR-PacificGalapagosDunbar1994
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-0.4084
<p style="margin-left: 0px"><strong>longitude: </strong>-91.234
<p style="margin-left: 0px"><strong>elevation: </strong>-1.5
<p style="margin-left: 0px"><strong>siteName: </strong>Urvina Bay, Galapagos Islands
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_173
...
<p style="margin-left: 20px"><strong>fraction: </strong>81%
<p style="margin-left: 20px"><strong>inferredMaterial: </strong>seawater
<p style="margin-left: 20px"><strong>integrationTime: </strong>1
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>The annual UR-87 chronology is based on counts of dense bands observed in X radiograph positive prints as well as stable isotope profiles
...
<details style="margin-left: 20px">
<summary>3</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Very poor signal
<p style="margin-left: 20px"><strong>inferredMaterial: </strong>seawater
<p style="margin-left: 20px"><strong>integrationTime: </strong>1
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong> The annual UR-87 chronology is based on counts of dense bands observed in X radiograph positive prints as well as stable isotope profiles
<p style="margin-left: 20px"><strong>integrationTimeUnits: </strong>year
