...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-CHIN018.Li.2010.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/12599
...
<p style="margin-left: 10px"><strong>author: </strong>Li, J.
<p style="margin-left: 10px"><strong>citeKey: </strong>li2011httpswwwncdcnoaagovpaleostudy12599DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>29.28
<p style="margin-left: 0px"><strong>longitude: </strong>100.08
<p style="margin-left: 0px"><strong>elevation: </strong>2150
<p style="margin-left: 0px"><strong>siteName: </strong>CHIN018
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_040
