...
```
#Asi-HBMXJP.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-HBMXJP.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>siteName: </strong>HBMXJP
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_059
