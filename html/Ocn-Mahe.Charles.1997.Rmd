...
```
#Ocn-Mahe.Charles.1997

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Mahe.Charles.1997.lpd)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>charles1997interactionbetweentheenso
<p style="margin-left: 10px"><strong>journal: </strong>Science
<p style="margin-left: 10px"><strong>volume: </strong>277
<p style="margin-left: 10px"><strong>pages: </strong>925-928
...
<p style="margin-left: 10px"><strong>author: </strong>Charles, C.D.
<p style="margin-left: 10px"><strong>citeKey: </strong>charles1997httpswwwncdcnoaagovpaleostudy1857DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-4.62
<p style="margin-left: 0px"><strong>longitude: </strong>55
<p style="margin-left: 0px"><strong>elevation: </strong>-7
<p style="margin-left: 0px"><strong>siteName: </strong>Mahe
