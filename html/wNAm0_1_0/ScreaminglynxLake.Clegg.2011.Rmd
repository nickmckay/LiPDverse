...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/ScreaminglynxLake.Clegg.2011.lpd)
            

[Download data only (csv)](ScreaminglynxLake.Clegg.2011.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEBdb20a8d4
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB21dc5255
...
<p style="margin-left: 10px"><strong>TSid: </strong>GHd4a391f9
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH29e1e772
...
<p style="margin-left: 10px"><strong>TSid: </strong>GHc7456c0b
