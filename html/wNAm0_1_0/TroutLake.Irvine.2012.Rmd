...
```
#TroutLake.Irvine.2012

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](TroutLake.Irvine.2012.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/TroutLake.Irvine.2012.lpd)
            

[Download data only (csv)](TroutLake.Irvine.2012.csv)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/13094
...
<p style="margin-left: 10px"><strong>citeKey: </strong>irvine2012midgeinferredtemperaturer
<p style="margin-left: 10px"><strong>journal: </strong>Journal of Paleolimnology
<p style="margin-left: 10px"><strong>volume: </strong>48
<p style="margin-left: 10px"><strong>pages: </strong>133-146
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB936709dd
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB2a70449e
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH077f3191
