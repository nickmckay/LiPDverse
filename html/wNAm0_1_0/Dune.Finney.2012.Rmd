...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/Dune.Finney.2012.lpd)
            

[Download data only (csv)](Dune.Finney.2012.csv)
...
<details style="margin-left: 10px">
<summary>DUNE_A (unitless)</summary>
