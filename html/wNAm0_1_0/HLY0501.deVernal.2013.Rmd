...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/HLY0501.deVernal.2013.lpd)
            

[Download data only (csv)](HLY0501.deVernal.2013.csv)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>de2013dinocystbasedreconstructi
...
<p style="margin-left: 10px"><strong>pages: </strong>111-121
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEB9dc8426d
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEBa72181d5
...
<p style="margin-left: 10px"><strong>TSid: </strong>GHe60adf07
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH7abab671
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH0f49f335
...
<p style="margin-left: 10px"><strong>TSid: </strong>GHe6426627
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH1907c477
<p style="margin-left: 10px"><strong>variableName: </strong>productivity
<p style="margin-left: 10px"><strong>units: </strong>gcm2
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>C (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH1893dfd8
