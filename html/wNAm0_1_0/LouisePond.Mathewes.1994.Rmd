...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/LouisePond.Mathewes.1994.lpd)
            

[Download data only (csv)](LouisePond.Mathewes.1994.csv)
...
<p style="margin-left: 10px"><strong>description: </strong>unpublished precipitaiton reconstruction
<details>
<summary>interpretation</summary>
<details style="margin-left: 20px">
<summary>1</summary>
