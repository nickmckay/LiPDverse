...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/Chichancanab.Hodell.1995.lpd)
            

[Download data only (csv)](Chichancanab.Hodell.1995.csv)
...
<details style="margin-left: 10px">
<summary>d18OPhysocypriaSp_ (permil) [3-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GHc5186b8c
<p style="margin-left: 10px"><strong>variableName: </strong>d18OPhysocypriaSp_
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>TRUE
<details>
<summary>interpretation</summary>
...
<details style="margin-left: 10px">
<summary>d13CPyrgophorusSp_ (permil) [3-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH38f8a604
<p style="margin-left: 10px"><strong>variableName: </strong>d13CPyrgophorusSp_
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>d13CPhysocypriaSp_ (permil) [3-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GHc32c90e8
<p style="margin-left: 10px"><strong>variableName: </strong>d13CPhysocypriaSp_
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
...
<details style="margin-left: 10px">
<summary>d18OCyprinotusSp_ (permil) [4-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH79bd61b5
<p style="margin-left: 10px"><strong>variableName: </strong>d18OCyprinotusSp_
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>d13CCyprinotusSp_ (permil) [4-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GHd6d32d0a
<p style="margin-left: 10px"><strong>variableName: </strong>d13CCyprinotusSp_
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
...
<details style="margin-left: 10px">
<summary>d18OAmmoniaBeccarii (permil) [5-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GHb76f6725
<p style="margin-left: 10px"><strong>variableName: </strong>d18OAmmoniaBeccarii
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>d13CAmmoniaBeccarii (permil) [5-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH5e456b2d
<p style="margin-left: 10px"><strong>variableName: </strong>d13CAmmoniaBeccarii
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>TotalAmmoniaBeccarii (unitless) [5-1]</summary>
...
<details style="margin-left: 10px">
<summary>d13CTerrestrialGastropods (permil) [6-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH747a63d7
<p style="margin-left: 10px"><strong>variableName: </strong>d13CTerrestrialGastropods
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
### d18OPhysocypriaSp_ (permil) [3-1]
```{r}
plotCol(thisTS,ind = 12)
```

### d13CPyrgophorusSp_ (permil) [3-1]
```{r}
plotCol(thisTS,ind = 11)
```

### d13CPhysocypriaSp_ (permil) [3-1]
```{r}
plotCol(thisTS,ind = 13)
```

### d18OCyprinotusSp_ (permil) [4-1]
```{r}
plotCol(thisTS,ind = 14)
```

### d13CCyprinotusSp_ (permil) [4-1]
```{r}
plotCol(thisTS,ind = 17)
```

### d18OAmmoniaBeccarii (permil) [5-1]
```{r}
plotCol(thisTS,ind = 18)
```

### d13CAmmoniaBeccarii (permil) [5-1]
```{r}
plotCol(thisTS,ind = 21)
```

### TotalAmmoniaBeccarii (unitless) [5-1]
```{r}
...
### d13CTerrestrialGastropods (permil) [6-1]
```{r}
