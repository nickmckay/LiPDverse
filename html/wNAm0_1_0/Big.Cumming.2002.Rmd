...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/wNAm0_1_0/Big.Cumming.2002.lpd)
            

[Download data only (csv)](Big.Cumming.2002.csv)
...
<details style="margin-left: 10px">
<summary>Mean_boot_salinity (unitless)</summary>
