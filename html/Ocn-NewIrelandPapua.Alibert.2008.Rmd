---
title: "Ocn-NewIrelandPapua.Alibert.2008"
output: 
...
```
#Ocn-NewIrelandPapua.Alibert.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-NewIrelandPapua.Alibert.2008.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/8604
...
<p style="margin-left: 10px"><strong>author: </strong>Alibert, Chantal;Kinsley, Leslie
<p style="margin-left: 10px"><strong>citeKey: </strong>alibert2008a170yearsrcaandbacacoralr
...
<p style="margin-left: 10px"><strong>title: </strong>A 170-year Sr/Ca and Ba/Ca coral record from the western Pacific warm pool: 2. A window into variability of the New Ireland Coastal Undercurrent
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/2007JC004263
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>author: </strong>Alibert, C.A.
<p style="margin-left: 10px"><strong>citeKey: </strong>alibert2010httpswwwncdcnoaagovpaleostudy8604DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>150.5
<p style="margin-left: 0px"><strong>elevation: </strong>-8
<p style="margin-left: 0px"><strong>siteName: </strong>New Ireland, Papua
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_143
