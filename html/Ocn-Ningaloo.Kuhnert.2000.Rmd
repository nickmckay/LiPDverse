---
title: "Ocn-Ningaloo.Kuhnert.2000"
output: 
...
```
#Ocn-Ningaloo.Kuhnert.2000

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Ningaloo.Kuhnert.2000.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>http://hurricane.ncdc.noaa.gov/pls/paleox/f?p=519:1:::::P1_study_id:1867
...
<p style="margin-left: 10px"><strong>author: </strong>Kuhnert, H.;Pätzold, J.;Wyrwoll, K.H.;Wefer, G.
<p style="margin-left: 10px"><strong>citeKey: </strong>kuhnert2000monitoringclimatevariabil
...
<p style="margin-left: 10px"><strong>pages: </strong>725-732
<p style="margin-left: 10px"><strong>pubYear: </strong>2000
<p style="margin-left: 10px"><strong>title: </strong>Monitoring climate variability over the past 116 years in coral oxygen isotopes from Ningaloo Reef, Western Australia
...
<p style="margin-left: 10px"><strong>citeKey: </strong>kuhnert2001httpswwwncdcnoaagovpaleostudy1867DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Ningaloo
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_008
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_009
