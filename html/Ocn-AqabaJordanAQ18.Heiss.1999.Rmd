---
title: "Ocn-AqabaJordanAQ18.Heiss.1999"
output: 
...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-AqabaJordanAQ18.Heiss.1999.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>http://hurricane.ncdc.noaa.gov/pls/paleox/f?p=519:1:::::P1_study_id:1854
...
<p style="margin-left: 10px"><strong>author: </strong>Heiss, G.A.;Dullo, W.C.;Joachimski, M.M.;Reijmer, J.J.G.;Schuhmacher, H.
<p style="margin-left: 10px"><strong>citeKey: </strong>heiss1999increasedseasonalityinthe
<p style="margin-left: 10px"><strong>journal: </strong>Senkenbergiana Maritima
<p style="margin-left: 10px"><strong>volume: </strong>30
<p style="margin-left: 10px"><strong>pages: </strong>17-26
<p style="margin-left: 10px"><strong>pubYear: </strong>1999
<p style="margin-left: 10px"><strong>title: </strong>Increased seasonality in the Gulf of Aqaba, Red Sea, recorded in the oxygen isotope record of a Porites lutea coral
<p style="margin-left: 10px"><strong>DOI: </strong>10.1007/BF03042826
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>author: </strong>Heiss, G.A.
<p style="margin-left: 10px"><strong>citeKey: </strong>heiss1994httpswwwncdcnoaagovpaleostudy1854DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>29.42
<p style="margin-left: 0px"><strong>longitude: </strong>34.97
<p style="margin-left: 0px"><strong>elevation: </strong>-1
<p style="margin-left: 0px"><strong>siteName: </strong>Aqaba, Jordan
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_014
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_015
