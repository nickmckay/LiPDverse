...
```
#Asi-MONG016.Jacoby.2010

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MONG016.Jacoby.2010.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/12651
...
<p style="margin-left: 10px"><strong>citeKey: </strong>jacoby2011httpswwwncdcnoaagovpaleostudy12651DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>88.37
<p style="margin-left: 0px"><strong>elevation: </strong>880
<p style="margin-left: 0px"><strong>siteName: </strong>MONG016
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_139
