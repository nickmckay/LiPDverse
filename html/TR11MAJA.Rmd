...
<p style="margin-left: 20px"><strong>variable: </strong>Precipitation amount and Relative humidity
...
<p style="margin-left: 20px"><strong>coefficient: </strong>0.44
<p style="margin-left: 20px"><strong>direction: </strong>Positive
<p style="margin-left: 20px"><strong>fraction: </strong>0.19
