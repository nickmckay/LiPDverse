---
title: "Ocn-MontegoBayJamaica.Haase-Schramm.2003"
output: 
...
```
#Ocn-MontegoBayJamaica.Haase-Schramm.2003

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-MontegoBayJamaica.Haase-Schramm.2003.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Haase-Schramm, Alexandra;Böhm, Florian;Eisenhauer, Anton;Dullo, Wolf-Christian;Joachimski, Michael M.;Hansen, Bent;Reitner, Joachim
<p style="margin-left: 10px"><strong>citeKey: </strong>haase2003srcaratiosandoxygenisotop
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>18
<p style="margin-left: 10px"><strong>pages: </strong>PA1073
...
<p style="margin-left: 10px"><strong>citeKey: </strong>haase2003httpswwwncdcnoaagovpaleostudy1878DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>18.4667
<p style="margin-left: 0px"><strong>longitude: </strong>-77.95
<p style="margin-left: 0px"><strong>elevation: </strong>-20
<p style="margin-left: 0px"><strong>siteName: </strong>Montego Bay Jamaica
