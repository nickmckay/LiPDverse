...
```
#Asi-MQBXJP.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-MQBXJP.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>99.78
<p style="margin-left: 0px"><strong>elevation: </strong>800
<p style="margin-left: 0px"><strong>siteName: </strong>MQBXJP
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_052
