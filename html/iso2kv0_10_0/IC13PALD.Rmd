...
<details style="margin-left: 20px">
<summary>2</summary>
<p style="margin-left: 20px"><strong>basis: </strong>Van Ommen et al., 1997 : seasonal cycle calibration. This comparison yields an isotope‐temperature relation with a gradient (dδ/dT) of 0.44±0.02‰/°C
<p style="margin-left: 20px"><strong>direction: </strong>positive
