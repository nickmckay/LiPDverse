...
<summary>1</summary>
<p style="margin-left: 20px"><strong>basis: </strong>"In the warm season (May–October) the isotopic composition depends on local temperatures, but the correlation is not persistent over time, while in the cold season (November–April), atmospheric circulation is the predominant driver of the ice core’s isotopic composition."
