...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC76FIDE.lpd)
            

[Download data only (csv)](IC76FIDE.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDf81d556d
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC76FIDE01A
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC76FIDE02A
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>d18O of glacier ice
<details>
