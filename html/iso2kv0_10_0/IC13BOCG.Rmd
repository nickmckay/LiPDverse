...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IC13BOCG.lpd)
            

[Download data only (csv)](IC13BOCG.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>Bohleber
<p style="margin-left: 10px"><strong>pubYear: </strong>NA
<p style="margin-left: 10px"><strong>DOI: </strong>10.3402/tellusb.v65i0.20148
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>45.9297
<p style="margin-left: 0px"><strong>longitude: </strong>7.877
<p style="margin-left: 0px"><strong>elevation: </strong>4450
<p style="margin-left: 0px"><strong>siteName: </strong>Colle Gnifetti KCI
</details>
<details open>
...
<p style="margin-left: 10px"><strong>TSid: </strong>IC13BOCG04A
...
<p style="margin-left: 20px"><strong>integrationTimeBasis: </strong>based on counting of annual layers (major ions) and reference horizons (Tritium, Saharan dust and volcanic)
<p style="margin-left: 20px"><strong>integrationTimeUncertainty: </strong><2.5
...
<details style="margin-left: 10px">
<summary>d18O (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>IC13BOCG02A
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>d18O of glacier ice
<details>
...
<details style="margin-left: 10px">
<summary>d18O (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>IC13BOCG03A
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>d18O of glacier ice
<details>
...
<details style="margin-left: 10px">
<summary>d18O (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>IC13BOCG01A
<p style="margin-left: 10px"><strong>variableName: </strong>d18O
<p style="margin-left: 10px"><strong>units: </strong>permil
<p style="margin-left: 10px"><strong>description: </strong>d18O of glacier ice
<details>
