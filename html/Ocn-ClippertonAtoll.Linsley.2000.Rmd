---
title: "Ocn-ClippertonAtoll.Linsley.2000"
output: 
...
```
#Ocn-ClippertonAtoll.Linsley.2000

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-ClippertonAtoll.Linsley.2000.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Linsley, Braddock K.;Ren, Lei;Dunbar, Robert B.;Howe, Stephen S.
<p style="margin-left: 10px"><strong>citeKey: </strong>linsley2000elniosouthernoscillatione
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>15
<p style="margin-left: 10px"><strong>pages: </strong>322-335
<p style="margin-left: 10px"><strong>pubYear: </strong>2000
<p style="margin-left: 10px"><strong>title: </strong>El Niño Southern Oscillation (ENSO) and decadal-scale climate variability at 10°N in the eastern Pacific from 1893 to 1994: A coral-based reconstruction from Clipperton Atoll
<p style="margin-left: 10px"><strong>DOI: </strong>10.1029/1999PA000428
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>citeKey: </strong>linsley2000httpswwwncdcnoaagovpaleostudy1846DataCitation
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_169
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_170
