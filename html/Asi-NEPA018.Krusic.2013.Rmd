...
```
#Asi-NEPA018.Krusic.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-NEPA018.Krusic.2013.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/3775
...
<p style="margin-left: 10px"><strong>citeKey: </strong>krusic2002httpswwwncdcnoaagovpaleostudy3775DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>86.33
<p style="margin-left: 0px"><strong>elevation: </strong>3600
<p style="margin-left: 0px"><strong>siteName: </strong>NEPA018
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_171
