---
title: "Ocn-Reunion.Pfeiffer.2004"
output: 
...
```
#Ocn-Reunion.Pfeiffer.2004

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Reunion.Pfeiffer.2004.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Pfeiffer, Miriam;Timm, Oliver;Dullo, Wolf-Christian;Podlech, Steffen
<p style="margin-left: 10px"><strong>citeKey: </strong>pfeiffer2004oceanicforcingofinterannu
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>19
<p style="margin-left: 10px"><strong>pages: </strong>PA4006
<p style="margin-left: 10px"><strong>pubYear: </strong>2004
<p style="margin-left: 10px"><strong>title: </strong>Oceanic forcing of interannual and multidecadal climate variability in the southwestern Indian Ocean: Evidence from a 160 year coral isotopic record (La Réunion, 55°E, 21°S)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>pfeiffer2004httpswwwncdcnoaagovpaleostudy1890DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Reunion
