...
```
#ForestPond1.Lynch.1998

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](ForestPond1.Lynch.1998.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/ForestPond1.Lynch.1998.lpd)
            

[Download paleoData only (csv)](ForestPond1.Lynch.1998.csv)
            

[Download chronData only (csv)](ForestPond1.Lynch.1998-chron.csv)
...
<p style="margin-left: 0px"><strong>longitude: </strong>-109.94
<p style="margin-left: 0px"><strong>elevation: </strong>2797
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L4prb4d87P
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2LhjzcxkyrP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L9odyggj2P
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lld263nsyP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LxwlndmzqP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lddu9d9uvP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lcbrtl8qlC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lv9366p4bC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lfhptsnr1C
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lhjqz4kfcC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2LvphoqurcC
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lq8axp7r2C
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lye2t2bzeC
