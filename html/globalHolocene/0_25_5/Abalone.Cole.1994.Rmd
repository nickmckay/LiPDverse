...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Abalone.Cole.1994.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Abalone.Cole.1994.lpd)
            

[Download paleoData only (csv)](Abalone.Cole.1994.csv)
            

[Download chronData only (csv)](Abalone.Cole.1994-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>33.96
<p style="margin-left: 0px"><strong>longitude: </strong>-119.98
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lj0pybo4zP
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (yr 14C yr BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lrrjfkw95P
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>yr 14C yr BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lupm3c8kbP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Luu75cnkxP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lhfelk1bfP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Leedqkm0xP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lv6dxx7nfC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Loou8rqvdC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lk7xtb0l0C
<p style="margin-left: 10px"><strong>variableName: </strong>labID
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lzdjjom1yC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2l649idlC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lyvd31bikC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>notes (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2La2i2dr8vC
