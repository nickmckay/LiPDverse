---
title: "IndianPrairieFen.Whitlock.1995"
output: 
...
```
#IndianPrairieFen.Whitlock.1995

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](IndianPrairieFen.Whitlock.1995.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/IndianPrairieFen.Whitlock.1995.lpd)
            

[Download paleoData only (csv)](IndianPrairieFen.Whitlock.1995.csv)
            

[Download chronData only (csv)](IndianPrairieFen.Whitlock.1995-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Sea, Debra S."), list(name = "Whitlock, Cathy"))
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>43
<p style="margin-left: 10px"><strong>pages: </strong>370-381
<p style="margin-left: 10px"><strong>title: </strong>Postglacial Vegetation and Climate of the Cascade Range, Central Oregon
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>44.63
<p style="margin-left: 0px"><strong>longitude: </strong>-122.58
<p style="margin-left: 0px"><strong>elevation: </strong>988
<p style="margin-left: 0px"><strong>siteName: </strong>Indian Prairie Fen
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LicjgbsdkP
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LbuavwugiP
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lkapeug29P
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lsjrqoms5P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L0w07fd9mP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lo9fmj4o8P
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lhgsnkg16C
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lqrv9g2wuC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L1orofv10C
<p style="margin-left: 10px"><strong>variableName: </strong>labID
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lnmv62t5fC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lxtcduo8hC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Llukl3fx7C
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>notes (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ljtfmjk14C
