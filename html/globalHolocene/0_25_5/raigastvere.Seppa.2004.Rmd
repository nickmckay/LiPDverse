...
```
#raigastvere.Seppa.2004

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](raigastvere.Seppa.2004.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/raigastvere.Seppa.2004.lpd)
            

[Download paleoData only (csv)](raigastvere.Seppa.2004.csv)
            

[Download chronData only (csv)](raigastvere.Seppa.2004-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Seppae, Heikki"), list(name = "Poska, Anneli"))
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>61
<p style="margin-left: 10px"><strong>title: </strong>Holocene annual mean temperature changes in Estonia and their relationship to solar insolation and atmospheric circulation patterns
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>longitude: </strong>26.65
<p style="margin-left: 0px"><strong>elevation: </strong>52.5
<p style="margin-left: 0px"><strong>siteName: </strong>raigastvere
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2JZXIQ74
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTD73YMWR3
...
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8HS111IP
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTB0MNJWHH
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTXT05NMG8
