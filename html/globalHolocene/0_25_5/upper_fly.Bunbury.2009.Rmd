...
```
#upper_fly.Bunbury.2009

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](upper_fly.Bunbury.2009.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/upper_fly.Bunbury.2009.lpd)
            

[Download paleoData only (csv)](upper_fly.Bunbury.2009.csv)
            

[Download chronData only (csv)](upper_fly.Bunbury.2009-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Bunbury, Joan"), list(name = "Gajewski, Konrad"))
...
<p style="margin-left: 10px"><strong>title: </strong>Postglacial climates inferred from a lake at treeline, southwest Yukon Territory, Canada
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>61.07
<p style="margin-left: 0px"><strong>longitude: </strong>-138.09
<p style="margin-left: 0px"><strong>elevation: </strong>1326
<p style="margin-left: 0px"><strong>siteName: </strong>upper_fly
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJGY2W1MZ
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTXRLAM6GY
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT1E469BV6
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJMDWVNSP
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (SD units) [1-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTRXOT29B2
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
...
<p style="margin-left: 20px"><strong>variable: </strong>T
<p style="margin-left: 20px"><strong>variableDetail: </strong>LST+air
</details>
</details>
</details>
<details style="margin-left: 10px">
<summary>age (BP) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTN68MW6I4
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>depth (cm) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT5ZXKENXQ
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTP4VYPRWB
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTAXJALM9J
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT609WASK0
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJID9IBDO
<p style="margin-left: 10px"><strong>variableName: </strong>depth_bot
<p style="margin-left: 10px"><strong>units: </strong>mm
</details>
<details style="margin-left: 10px">
<summary>depth_top (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT57SSEKWE
<p style="margin-left: 10px"><strong>variableName: </strong>depth_top
<p style="margin-left: 10px"><strong>units: </strong>mm
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT4U6J85LP
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (1s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTW18XL869
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTFJ4EWK4F
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTYZK9NX1I
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTMVAVW56W
<p style="margin-left: 10px"><strong>variableName: </strong>thickness
<p style="margin-left: 10px"><strong>units: </strong>mm
</details>
<details style="margin-left: 10px">
<summary>age_type (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJD2E9ATU
