---
title: "ThreePinesBog.McAndrews.1990"
output: 
...
```
#ThreePinesBog.McAndrews.1990

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](ThreePinesBog.McAndrews.1990.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/ThreePinesBog.McAndrews.1990.lpd)
            

[Download paleoData only (csv)](ThreePinesBog.McAndrews.1990.csv)
            

[Download chronData only (csv)](ThreePinesBog.McAndrews.1990-chron.csv)
...
<p style="margin-left: 0px"><strong>longitude: </strong>-80.12
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lf0j8vhp7P
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ldp59lq6gP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lb8lkduf3P
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lm347b5srP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Le5r3nhmzP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lti8b1kskP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LbapmezcgC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lthba9dqqC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L878g61b2C
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L9ernqzvaC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2LhobojbehC
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L0exv3oi0C
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2ozg4dy7C
