...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](SS49.Perren.2012.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/SS49.Perren.2012.lpd)
            

[Download paleoData only (csv)](SS49.Perren.2012.csv)
            

[Download chronData only (csv)](SS49.Perren.2012-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Perren, Bianca B."), list(name = "Anderson, N. John"), list(name = "Douglas, Marianne S. V."), list(name = "Fritz, Sherilyn C."))
<p style="margin-left: 10px"><strong>citeKey: </strong>perren2012theinfluenceoftemperature
<p style="margin-left: 10px"><strong>journal: </strong>Journal of Paleolimnology
<p style="margin-left: 10px"><strong>volume: </strong>48
<p style="margin-left: 10px"><strong>pages: </strong>223-239
<p style="margin-left: 10px"><strong>title: </strong>The influence of temperature, moisture, and eolian activity on Holocene lake development in West Greenland
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>66.86
<p style="margin-left: 0px"><strong>longitude: </strong>-52.64
<p style="margin-left: 0px"><strong>elevation: </strong>330
<p style="margin-left: 0px"><strong>siteName: </strong>SS49
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RjLu3xjC7Zq
...
<details style="margin-left: 10px">
<summary>CCA2 (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPD7be6185d
<p style="margin-left: 10px"><strong>variableName: </strong>CCA2
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details>
