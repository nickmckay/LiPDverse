...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](ranger.Brubaker.1983.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/ranger.Brubaker.1983.lpd)
            

[Download paleoData only (csv)](ranger.Brubaker.1983.csv)
            

[Download chronData only (csv)](ranger.Brubaker.1983-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>67.1472
<p style="margin-left: 0px"><strong>longitude: </strong>-153.65
<p style="margin-left: 0px"><strong>elevation: </strong>820
<p style="margin-left: 0px"><strong>siteName: </strong>ranger
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTTV7VF7SH
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTOS66KHG5
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT909ZJ7SN
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTCYF0YQTU
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8EVDFAZL
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTW8HHSCX2
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>TRUE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTAF59KC3Q
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTGWZBGAY4
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTNILWLUB0
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (years)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTY5PKDTE8
