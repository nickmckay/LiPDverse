...
```
#Redondo.Brubaker.1983

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Redondo.Brubaker.1983.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Redondo.Brubaker.1983.lpd)
            

[Download paleoData only (csv)](Redondo.Brubaker.1983.csv)
            

[Download chronData only (csv)](Redondo.Brubaker.1983-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Brubaker, Linda B."), list(name = "Garfinkel, Harriet L."), list(name = "Edwards, Mary E."))
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>20
<p style="margin-left: 10px"><strong>pages: </strong>194-214
<p style="margin-left: 10px"><strong>title: </strong>A Late Wisconsin and Holocene Vegetation History from the Central Brooks Range: Implications for Alaskan Palaeoecology
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>67.68
<p style="margin-left: 0px"><strong>longitude: </strong>-155.03
<p style="margin-left: 0px"><strong>elevation: </strong>460
<p style="margin-left: 0px"><strong>siteName: </strong>Redondo
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lsjfa5kezP
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L7jyhwr01P
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L9hcdnxd4P
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lc2pelj4jP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lh235uyiuP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L5ueqve9aP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lmlpm4ka9C
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lniw8d4ssC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lqo49en0tC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lpcu789ymC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2iu33015C
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lpbloiro4C
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>notes (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ladyfc8rlC
