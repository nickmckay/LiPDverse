---
title: "LakeKupal'noe.Ilyashuk.2013"
output: 
...
```
#LakeKupal'noe.Ilyashuk.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LakeKupal'noe.Ilyashuk.2013.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/LakeKupal'noe.Ilyashuk.2013.lpd)
            

[Download paleoData only (csv)](LakeKupal_noe.Ilyashuk.2013.csv)
            

[Download chronData only (csv)](LakeKupal_noe.Ilyashuk.2013-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Ilyashuk, Elena A."), list(name = "Ilyashuk, Boris P."), list(name = "Kolka, Vasily V."), list(name = "Hammarlund, Dan"))
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>79
<p style="margin-left: 10px"><strong>title: </strong>Holocene climate variability on the Kola Peninsula, Russian Subarctic, based on aquatic invertebrate records from lake sediments
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>67.66
<p style="margin-left: 0px"><strong>longitude: </strong>33.63
<p style="margin-left: 0px"><strong>elevation: </strong>352
<p style="margin-left: 0px"><strong>siteName: </strong>Lake Kupal'noe
...
<p style="margin-left: 10px"><strong>TSid: </strong>RoWMTFWZVEm
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>R9zYEGVCXN9
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RdEySvKpAzm
...
<p style="margin-left: 10px"><strong>TSid: </strong>RRcWjVPDZXy
...
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RWDsDvlneVo
<p style="margin-left: 10px"><strong>variableName: </strong>uncertainty
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>RhuZeCc0puu
