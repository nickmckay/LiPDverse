---
title: "arapisto.Sarmaja-Korjonen.2007"
output: 
...
```
#arapisto.Sarmaja-Korjonen.2007

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](arapisto.Sarmaja-Korjonen.2007.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/arapisto.Sarmaja-Korjonen.2007.lpd)
            

[Download paleoData only (csv)](arapisto.Sarmaja-Korjonen.2007.csv)
            

[Download chronData only (csv)](arapisto.Sarmaja-Korjonen.2007-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Sarmaja-Korjonen, Kaarina"), list(name = "Seppae, Heikki"))
<p style="margin-left: 10px"><strong>journal: </strong>The Holocene
<p style="margin-left: 10px"><strong>volume: </strong>17
<p style="margin-left: 10px"><strong>title: </strong>Abrupt and consistent responses of aquatic and terrestrial ecosystems to the 8200 cal. yr cold event: a lacustrine record from Lake Arapisto, Finland
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>longitude: </strong>24.8
<p style="margin-left: 0px"><strong>elevation: </strong>133
<p style="margin-left: 0px"><strong>siteName: </strong>arapisto
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTELXMRL2E
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT37OXUDO9
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTXFMZ1EQU
...
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTMSL1FKH3
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTF3EWJ7BT
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTLTU0VPD1
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJX6KF0CE
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2RPT25K8
