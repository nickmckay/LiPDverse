...
```
#LakeEC2.Gajewski.1991

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LakeEC2.Gajewski.1991.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/LakeEC2.Gajewski.1991.lpd)
            

[Download paleoData only (csv)](LakeEC2.Gajewski.1991.csv)
            

[Download chronData only (csv)](LakeEC2.Gajewski.1991-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-74.95
<p style="margin-left: 0px"><strong>longitude: </strong>56.02
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lcweoc9evP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Li0gv4wtqP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lpiyhg2dyP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lsekb4bsqP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L5adu400zP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lr5wm8ssgP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LevdvjgglC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ljlz9ysbpC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LcvkmvotjC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2wbafns5C
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lhfunz4xxC
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lx7o112ebC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2i3cy0ooC
