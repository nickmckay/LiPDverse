...
```
#spaime.Hammarlund.2004

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](spaime.Hammarlund.2004.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/spaime.Hammarlund.2004.lpd)
            

[Download paleoData only (csv)](spaime.Hammarlund.2004.csv)
            

[Download chronData only (csv)](spaime.Hammarlund.2004-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Hammarlund, Dan"), list(name = "Velle, Gaute"), list(name = "Wolfe, Brent B."), list(name = "Edwards, Thomas W.D."), list(name = "Barnekow, Lena"), list(name = "Bergman, Jonas"), list(name = "Holmgren, Sofia"), list(name = "Lamme, Sara"), list(name = "Snowball, Ian"), list(name = "Wohlfarth, Barbara"), list(name = "Possnert, Goeran"))
<p style="margin-left: 10px"><strong>journal: </strong>The Holocene
<p style="margin-left: 10px"><strong>volume: </strong>14
<p style="margin-left: 10px"><strong>title: </strong>Palaeolimnological and sedimentary responses to Holocene forest retreat in                 the Scandes Mountains, west-central Sweden
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>siteName: </strong>spaime
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTRI17RHHW
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8OJ265Q7
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTE4BGWG4T
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT56HG1T2R
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2GAS4FD5
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>d18O (permil v smow) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHHASQEBI
...
<p style="margin-left: 20px"><strong>variableDetail: </strong>NAO
</details>
</details>
</details>
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTD0DZI3X4
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTFHZ208VV
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTEVGCFAR2
