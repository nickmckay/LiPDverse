...
```
#MD99-2269.Justwan.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](MD99-2269.Justwan.2008.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/MD99-2269.Justwan.2008.lpd)
            

[Download paleoData only (csv)](MD99-2269.Justwan.2008.csv)
            

[Download chronData only (csv)](MD99-2269.Justwan.2008-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Justwan, Aurelie"), list(name = "Koc, Nalan"), list(name = "Jennings, Anne E."))
...
<p style="margin-left: 10px"><strong>title: </strong>Evolution of the Irminger and East Icelandic Current systems through the Holocene, revealed by diatom-based sea surface temperature reconstructions
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>66.85
<p style="margin-left: 0px"><strong>longitude: </strong>-20.85
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTR42KT95P
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTRM8XIQ8J
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTDMRGDD7W
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTKGP4NISI
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (years)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2OWWD9TM
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHDNMODF3
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2H85EWI4
