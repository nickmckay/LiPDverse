...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](holebudalen..2009.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/holebudalen..2009.lpd)
            

[Download paleoData only (csv)](holebudalen..2009.csv)
            

[Download chronData only (csv)](holebudalen..2009-chron.csv)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>sepp2009lastninethousandyearsofte
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTD2RNKFMS
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2D22MLXU
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH9c3eb7f7dp
