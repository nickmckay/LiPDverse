...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](ParkPond1.Lynch.1998.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/ParkPond1.Lynch.1998.lpd)
            

[Download paleoData only (csv)](ParkPond1.Lynch.1998.csv)
            

[Download chronData only (csv)](ParkPond1.Lynch.1998-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Lynch, Elizabeth A."))
<p style="margin-left: 10px"><strong>journal: </strong>Ecology
<p style="margin-left: 10px"><strong>volume: </strong>79
<p style="margin-left: 10px"><strong>pages: </strong>1320-1338
<p style="margin-left: 10px"><strong>title: </strong>ORIGIN OF A PARK–FOREST VEGETATION MOSAIC IN THE WIND RIVER RANGE, WYOMING
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>longitude: </strong>-109.96
<p style="margin-left: 0px"><strong>elevation: </strong>2705
<p style="margin-left: 0px"><strong>siteName: </strong>Park Pond
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lnjdrmmt9P
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LyyjpbmpdP
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L63wmizbwP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L8gmvex23P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lubfra1b3P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ld1pgjspxP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ln4bbo3lbC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L33i0j4t1C
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lnp6j5p3kC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L7pvhe31cC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L3k5b1w0vC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lvqaab2syC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>notes (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ln55zl6dqC
