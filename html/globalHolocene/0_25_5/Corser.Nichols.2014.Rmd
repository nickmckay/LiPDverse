...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Corser.Nichols.2014.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Corser.Nichols.2014.lpd)
            

[Download paleoData only (csv)](Corser.Nichols.2014.csv)
            

[Download chronData only (csv)](Corser.Nichols.2014-chron.csv)
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTWUXSTL2M
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTUQPUNFJT
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTZYIC0QP8
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT0ISXTPWY
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTIZMD4E9O
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (1_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT78H9F2Q6
