---
title: "LacFaribault.Larouche.1981"
output: 
...
```
#LacFaribault.Larouche.1981

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](LacFaribault.Larouche.1981.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/LacFaribault.Larouche.1981.lpd)
            

[Download paleoData only (csv)](LacFaribault.Larouche.1981.csv)
            

[Download chronData only (csv)](LacFaribault.Larouche.1981-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>58.87
<p style="margin-left: 0px"><strong>longitude: </strong>-71.72
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lktnw5b22P
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lj3u3nqafP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lunmw92slP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2La71kexf0P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ly0wxhoe3P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lkadbwg06P
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L1e2jsin3C
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lq4upomwkC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L4tzxswzmC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L3k04o7p6C
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lnnbtkx7iC
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lvyecj8n2C
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lxi6hos4tC
