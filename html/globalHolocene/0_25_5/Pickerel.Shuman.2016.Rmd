...
```
#Pickerel.Shuman.2016

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Pickerel.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Pickerel.Shuman.2016.lpd)
            

[Download paleoData only (csv)](Pickerel.Shuman.2016.csv)
            

[Download chronData only (csv)](Pickerel.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "WATTS, W. A."), list(name = "BRIGHT, R. C."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
...
<p style="margin-left: 10px"><strong>title: </strong>Pollen, Seed, and Mollusk Analysis of a Sediment Core from Pickerel Lake, Northeastern South Dakota
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>45.5052
<p style="margin-left: 0px"><strong>longitude: </strong>-97.2743
<p style="margin-left: 0px"><strong>elevation: </strong>563
<p style="margin-left: 0px"><strong>siteName: </strong>Pickerel
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RRj1jBnMKjY
...
<p style="margin-left: 10px"><strong>TSid: </strong>RWUTQ09oKuP
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH90151260
