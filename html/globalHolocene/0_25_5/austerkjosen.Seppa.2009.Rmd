...
```
#austerkjosen.Seppa.2009

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](austerkjosen.Seppa.2009.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/austerkjosen.Seppa.2009.lpd)
            

[Download paleoData only (csv)](austerkjosen.Seppa.2009.csv)
            

[Download chronData only (csv)](austerkjosen.Seppa.2009-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>68.5333
<p style="margin-left: 0px"><strong>longitude: </strong>17.2667
<p style="margin-left: 0px"><strong>elevation: </strong>135
<p style="margin-left: 0px"><strong>siteName: </strong>austerkjosen
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT4IT5BLL4
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHZNFZ481
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTLCCXN62R
...
<summary>1</summary>
<p style="margin-left: 20px"><strong>direction: </strong>posiitve
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJKVX8V6Y
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTDZLK6RBO
