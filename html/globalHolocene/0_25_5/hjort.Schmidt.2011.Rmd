...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](hjort.Schmidt.2011.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/hjort.Schmidt.2011.lpd)
            

[Download paleoData only (csv)](hjort.Schmidt.2011.csv)
            

[Download chronData only (csv)](hjort.Schmidt.2011-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "SCHMIDT, STEFFI"), list(name = "WAGNER, BERND"), list(name = "HEIRI, OLIVER"), list(name = "KLUG, MARTIN"), list(name = "BENNIKE, OLE"), list(name = "MELLES, MARTIN"))
<p style="margin-left: 10px"><strong>journal: </strong>Boreas
<p style="margin-left: 10px"><strong>volume: </strong>40
<p style="margin-left: 10px"><strong>title: </strong>Chironomids as indicators of the Holocene climatic and environmental history of two lakes in Northeast Greenland
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>76.433
<p style="margin-left: 0px"><strong>longitude: </strong>-18.767
<p style="margin-left: 0px"><strong>elevation: </strong>114
<p style="margin-left: 0px"><strong>siteName: </strong>hjort
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT485UDDL4
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT1JZ8LCCF
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>CCA1 (sd units)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT88A4DF9B
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHPRFTY41
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTDVV376P2
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJTEFBB44
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTS6VO0HRI
