---
title: "reiarsdalsvatnet.Seppa.2009"
output: 
...
```
#reiarsdalsvatnet.Seppa.2009

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](reiarsdalsvatnet.Seppa.2009.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/reiarsdalsvatnet.Seppa.2009.lpd)
            

[Download paleoData only (csv)](reiarsdalsvatnet.Seppa.2009.csv)
            

[Download chronData only (csv)](reiarsdalsvatnet.Seppa.2009-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>58.3167
<p style="margin-left: 0px"><strong>longitude: </strong>7.7833
<p style="margin-left: 0px"><strong>elevation: </strong>245
<p style="margin-left: 0px"><strong>siteName: </strong>reiarsdalsvatnet
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT0X91FS9Z
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTUQ99BKI6
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTLC5FYZTA
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTGJNF3D9J
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTNXV0F1P4
