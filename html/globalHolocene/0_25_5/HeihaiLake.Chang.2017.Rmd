...
```
#HeihaiLake.Chang.2017

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](HeihaiLake.Chang.2017.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/HeihaiLake.Chang.2017.lpd)
            

[Download paleoData only (csv)](HeihaiLake.Chang.2017.csv)
            

[Download chronData only (csv)](HeihaiLake.Chang.2017-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Chang, Jie"), list(name = "Zhang, Enlou"), list(name = "Liu, Enfeng"), list(name = "Shulmeister, James"))
<p style="margin-left: 10px"><strong>journal: </strong>The Holocene
<p style="margin-left: 10px"><strong>volume: </strong>27
<p style="margin-left: 10px"><strong>title: </strong>Summer temperature variability inferred from subfossil chironomid assemblages from the south-east margin of the Qinghai–Tibetan Plateau for the last 5000 years
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>27.36
<p style="margin-left: 0px"><strong>longitude: </strong>100.67
<p style="margin-left: 0px"><strong>elevation: </strong>4118
<p style="margin-left: 0px"><strong>siteName: </strong>Heihai Lake
...
<p style="margin-left: 10px"><strong>TSid: </strong>R90Qx3HdjaO
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RZdZqWLE8jn
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RiGB29gyPkL
...
<p style="margin-left: 10px"><strong>TSid: </strong>RycHLoobRmE
...
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RIzvUYvkjbJ
<p style="margin-left: 10px"><strong>variableName: </strong>uncertainty
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>R1fh5PMjNja
