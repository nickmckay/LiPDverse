...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/PixieLake.Brown.2006.lpd)
            

[Download paleoData only (csv)](PixieLake.Brown.2006.csv)
            

[Download chronData only (csv)](PixieLake.Brown.2006-chron.csv)
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>WEB2c4ffd7b
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (yrBP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>WEB8d096094
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>yrBP
<p style="margin-left: 10px"><strong>description: </strong>Mazama ash age based on Hallett et al., 1997
</details>
<details style="margin-left: 10px">
<summary>laboratory number (NA)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>WEB6277989f
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEBf8fc4d93
...
<p style="margin-left: 10px"><strong>TSid: </strong>WEBc86c1eec
