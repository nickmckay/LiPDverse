---
title: "trehorningen.Antonsson.2007"
output: 
...
```
#trehorningen.Antonsson.2007

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](trehorningen.Antonsson.2007.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/trehorningen.Antonsson.2007.lpd)
            

[Download paleoData only (csv)](trehorningen.Antonsson.2007.csv)
            

[Download chronData only (csv)](trehorningen.Antonsson.2007-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Antonsson, Karin"), list(name = "Seppae, Heikki"))
<p style="margin-left: 10px"><strong>journal: </strong>Boreas
<p style="margin-left: 10px"><strong>volume: </strong>36
<p style="margin-left: 10px"><strong>title: </strong>Holocene temperatures in Bohuslän, southwest Sweden: a quantitative reconstruction from fossil pollen data
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>58.55
<p style="margin-left: 0px"><strong>longitude: </strong>11.6
<p style="margin-left: 0px"><strong>elevation: </strong>112
<p style="margin-left: 0px"><strong>siteName: </strong>trehorningen
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTU3UMEOY9
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTT1JA62S9
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTYAXHRPNM
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTF0Y926ZL
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTNWAMAS0N
