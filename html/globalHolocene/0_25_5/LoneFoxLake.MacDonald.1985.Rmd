...
[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/LoneFoxLake.MacDonald.1985.lpd)
            

[Download paleoData only (csv)](LoneFoxLake.MacDonald.1985.csv)
            

[Download chronData only (csv)](LoneFoxLake.MacDonald.1985-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "MacDonald, Glen M."), list(name = "Cwynar, Les C."))
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L987ex5xyC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lltyrs4obC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lq3pelw54C
<p style="margin-left: 10px"><strong>variableName: </strong>labID
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lfff9lajpC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L53bhpjv5C
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2LeblalnisC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>notes (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Le2pxn9mcC
