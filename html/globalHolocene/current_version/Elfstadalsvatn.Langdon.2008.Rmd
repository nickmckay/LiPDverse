---
title: "Elfstadalsvatn.Langdon.2008"
output: 
...
```
#Elfstadalsvatn.Langdon.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Elfstadalsvatn.Langdon.2008.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Elfstadalsvatn.Langdon.2008.lpd)
            

[Download paleoData only (csv)](Elfstadalsvatn.Langdon.2008.csv)
            

[Download chronData only (csv)](Elfstadalsvatn.Langdon.2008-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Langdon, Peter G."), list(name = "Holmes, Naomi"), list(name = "Caseldine, Chris J."))
<p style="margin-left: 10px"><strong>journal: </strong>Journal of Paleolimnology
<p style="margin-left: 10px"><strong>volume: </strong>40
<p style="margin-left: 10px"><strong>title: </strong>Environmental controls on modern chironomid faunas from NW Iceland and implications for reconstructing climate change
</details>
<details style="margin-left: 10px">
<summary>pub2</summary>
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Caseldine, Chris"), list(name = "Geirsdottir, Aslaug"), list(name = "Langdon, Peter"))
<p style="margin-left: 10px"><strong>journal: </strong>Journal of Paleolimnology
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>66.92
<p style="margin-left: 0px"><strong>longitude: </strong>21.67
<p style="margin-left: 0px"><strong>elevation: </strong>123
<p style="margin-left: 0px"><strong>siteName: </strong>Elfstadalsvatn
<p style="margin-left: 0px"><strong>country: </strong>Iceland
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RA2tpP21WDb
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (Calibrated)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RJJ8Dz4gitT
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>Calibrated
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>Rc9cuWIUbO5
...
<p style="margin-left: 10px"><strong>TSid: </strong>RR8ibhZ5Yls
...
<p style="margin-left: 10px"><strong>TSid: </strong>RUBqY8we3fE
...
<p style="margin-left: 10px"><strong>TSid: </strong>REWmXHuW6xo
...
<p style="margin-left: 10px"><strong>TSid: </strong>RisxarrT70I
