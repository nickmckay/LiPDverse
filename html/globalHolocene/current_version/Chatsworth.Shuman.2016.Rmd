...
```
#Chatsworth.Shuman.2016

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Chatsworth.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Chatsworth.Shuman.2016.lpd)
            

[Download paleoData only (csv)](Chatsworth.Shuman.2016.csv)
            

[Download chronData only (csv)](Chatsworth.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "King, James E."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
<p style="margin-left: 10px"><strong>journal: </strong>Ecological Monographs
<p style="margin-left: 10px"><strong>volume: </strong>51
<p style="margin-left: 10px"><strong>title: </strong>Late Quaternary Vegetational History of Illinois
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>40.68
<p style="margin-left: 0px"><strong>longitude: </strong>-88.34
<p style="margin-left: 0px"><strong>elevation: </strong>230
<p style="margin-left: 0px"><strong>siteName: </strong>Chatsworth
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RoiWP7rc9gG
...
<p style="margin-left: 10px"><strong>TSid: </strong>Rq7OY7nHF51
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD33b45b88
