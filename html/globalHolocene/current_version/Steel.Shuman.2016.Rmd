...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Steel.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Steel.Shuman.2016.lpd)
            

[Download paleoData only (csv)](Steel.Shuman.2016.csv)
            

[Download chronData only (csv)](Steel.Shuman.2016-chron.csv)
...
<p style="margin-left: 0px"><strong>longitude: </strong>-94.68
...
<p style="margin-left: 10px"><strong>TSid: </strong>Rko6qI7oBTv
...
<p style="margin-left: 10px"><strong>TSid: </strong>ROutZbRTiXj
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH64430e77
