---
title: "Tourbiere_deLanoraieJoseph.Comtois.1982"
output: 
...
```
#Tourbiere_deLanoraieJoseph.Comtois.1982

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Tourbiere_deLanoraieJoseph.Comtois.1982.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Tourbiere_deLanoraieJoseph.Comtois.1982.lpd)
            

[Download paleoData only (csv)](Tourbiere_deLanoraieJoseph.Comtois.1982.csv)
            

[Download chronData only (csv)](Tourbiere_deLanoraieJoseph.Comtois.1982-chron.csv)
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>45.99
<p style="margin-left: 0px"><strong>longitude: </strong>-73.3
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lf3yw6k2qP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lws1takzaP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lj91asrlrP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lsjkmjs0cP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lrn7z839uP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L8p1ptv1bP
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lb78476neC
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L2ksk9lozC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lv7b3w47jC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L4m0wyv7zC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lj7goqp28C
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ldyt4tuhjC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LencyibddC
