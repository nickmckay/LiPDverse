...
```
#SprucePond.Shuman.2016

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](SprucePond.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/SprucePond.Shuman.2016.lpd)
            

[Download paleoData only (csv)](SprucePond.Shuman.2016.csv)
            

[Download chronData only (csv)](SprucePond.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Maenza-Gmelch, Terryanne E."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
<p style="margin-left: 10px"><strong>journal: </strong>The Holocene
<p style="margin-left: 10px"><strong>volume: </strong>7
<p style="margin-left: 10px"><strong>title: </strong>Holocene vegetation, climate, and fire history of the Hudson Highlands, southeastern New York, USA
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>41.2368
<p style="margin-left: 0px"><strong>longitude: </strong>-74.1834
<p style="margin-left: 0px"><strong>elevation: </strong>223
<p style="margin-left: 0px"><strong>siteName: </strong>SprucePond
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RlXVyNKhAOk
...
<p style="margin-left: 10px"><strong>TSid: </strong>RaM8Iu4RZD3
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH059eaaac
