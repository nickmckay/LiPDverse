...
```
#MoonLake.Shuman.2016

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](MoonLake.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/MoonLake.Shuman.2016.lpd)
            

[Download paleoData only (csv)](MoonLake.Shuman.2016.csv)
            

[Download chronData only (csv)](MoonLake.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Laird, Kathleen R."), list(name = "Fritz, Sherilyn C."), list(name = "Grimm, Eric C."), list(name = "Mueller, Pietra G."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
...
<p style="margin-left: 10px"><strong>title: </strong>Century scale paleoclimatic reconstruction from Moon Lake, a closed-basin lake in the northern Great Plains
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>46.86
<p style="margin-left: 0px"><strong>longitude: </strong>-98.16
<p style="margin-left: 0px"><strong>elevation: </strong>400
<p style="margin-left: 0px"><strong>siteName: </strong>Moon Lake
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RNGPa6v4FbG
...
<p style="margin-left: 10px"><strong>TSid: </strong>R1Ik1QIKGFt
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH8c73b2a9
