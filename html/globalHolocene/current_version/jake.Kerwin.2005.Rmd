...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](jake.Kerwin.2005.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/jake.Kerwin.2005.lpd)
            

[Download paleoData only (csv)](jake.Kerwin.2005.csv)
            

[Download chronData only (csv)](jake.Kerwin.2005-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Miller, Gifford H."), list(name = "Wolfe, Alexander P."), list(name = "Briner, Jason P."), list(name = "Sauer, Peter E."), list(name = "Nesje, Atle"))
...
<p style="margin-left: 10px"><strong>title: </strong>Holocene glaciation and climate evolution of Baffin Island, Arctic Canada
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>63.667
<p style="margin-left: 0px"><strong>longitude: </strong>-65.152
<p style="margin-left: 0px"><strong>elevation: </strong>300
<p style="margin-left: 0px"><strong>siteName: </strong>jake
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTW5HXG2LK
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTVS1ZQZV7
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8O5BE482
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT0AKT9AEJ
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT1X1EXPLT
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTFEI2VLB4
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJY6656Y1
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (years)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTKDKCTC51
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTWWW65CX2
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTT14EW3JJ
<p style="margin-left: 10px"><strong>variableName: </strong>age_type
</details>
<details style="margin-left: 10px">
<summary>note ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTYW8BBALY
