---
title: "Saint-JeanIle_dOrleans.Larouche.1971"
output: 
...
```
#Saint-JeanIle_dOrleans.Larouche.1971

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Saint-JeanIle_dOrleans.Larouche.1971.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Saint-JeanIle_dOrleans.Larouche.1971.lpd)
            

[Download paleoData only (csv)](Saint-JeanIle_dOrleans.Larouche.1971.csv)
            

[Download chronData only (csv)](Saint-JeanIle_dOrleans.Larouche.1971-chron.csv)
...
<p style="margin-left: 0px"><strong>longitude: </strong>-70.93
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2LznhhmkqoP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lhtqm5dmfP
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2L6jjg500gP
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lemd7g470P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
...
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2LyqddixcyP
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lcv1tbc40P
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lzbqvhmm7C
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>ageType ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Lsh4we5mlC
<p style="margin-left: 10px"><strong>variableName: </strong>ageType
</details>
<details style="margin-left: 10px">
<summary>labID ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L0f8q8enaC
<p style="margin-left: 10px"><strong>variableName: </strong>labID
</details>
<details style="margin-left: 10px">
<summary>age14Cuncertainty (yr 14C)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2Ldkfat3wlC
...
<p style="margin-left: 10px"><strong>TSid: </strong>M2Liqhbl42pC
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>yr 14C BP
</details>
<details style="margin-left: 10px">
<summary>measurementMaterial ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L7q7n51wbC
<p style="margin-left: 10px"><strong>variableName: </strong>measurementMaterial
</details>
<details style="margin-left: 10px">
<summary>notes ()</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>M2L6iej9vduC
