...
```
#svanavatnet.Bjune.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](svanavatnet.Bjune.2008.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/svanavatnet.Bjune.2008.lpd)
            

[Download paleoData only (csv)](svanavatnet.Bjune.2008.csv)
            

[Download chronData only (csv)](svanavatnet.Bjune.2008-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "BJUNE, ANNE E."), list(name = "BIRKS, H. J. B."))
<p style="margin-left: 10px"><strong>journal: </strong>Boreas
<p style="margin-left: 10px"><strong>volume: </strong>37
<p style="margin-left: 10px"><strong>title: </strong>Holocene vegetation dynamics and inferred climate changes at Svanåvatnet, Mo i Rana, northern Norway
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>66.44
<p style="margin-left: 0px"><strong>longitude: </strong>14.05
<p style="margin-left: 0px"><strong>elevation: </strong>243
<p style="margin-left: 0px"><strong>siteName: </strong>svanavatnet
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTZKJKNK6T
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTU01IFDUZ
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTC5120NTS
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTQQ59PH63
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTVUR55CIE
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTMJ30JSZ9
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>TRUE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTIVWCZRW5
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8AUT5P8M
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTUW0YSXRV
