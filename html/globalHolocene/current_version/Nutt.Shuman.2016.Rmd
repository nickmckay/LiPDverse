...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Nutt.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Nutt.Shuman.2016.lpd)
            

[Download paleoData only (csv)](Nutt.Shuman.2016.csv)
            

[Download chronData only (csv)](Nutt.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "BENNETT, K. D."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
<p style="margin-left: 10px"><strong>journal: </strong>New Phytologist
<p style="margin-left: 10px"><strong>volume: </strong>103
<p style="margin-left: 10px"><strong>title: </strong>COMPETITIVE INTERACTIONS AMONG FOREST TREE POPULATIONS IN NORFOLK, ENGLAND, DURING THE LAST 10000 YEARS
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>45.2132
<p style="margin-left: 0px"><strong>longitude: </strong>-79.4496
<p style="margin-left: 0px"><strong>elevation: </strong>302
<p style="margin-left: 0px"><strong>siteName: </strong>Nutt Lake
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RC17aRoZAa8
...
<p style="margin-left: 10px"><strong>TSid: </strong>RNcklNoNxfA
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH7fb77a0c
