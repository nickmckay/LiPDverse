...
```
#DevilsLake.Shuman.2016

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](DevilsLake.Shuman.2016.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/DevilsLake.Shuman.2016.lpd)
            

[Download paleoData only (csv)](DevilsLake.Shuman.2016.csv)
            

[Download chronData only (csv)](DevilsLake.Shuman.2016-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Baker, Richard G."), list(name = "Maher, Louis J."), list(name = "Chumbley, Craig A."), list(name = "Van Zant, Kent L."))
<p style="margin-left: 10px"><strong>citeKey: </strong>shuman2016thestructureofholocenecli
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>37
<p style="margin-left: 10px"><strong>title: </strong>Patterns of Holocene Environmental Change in the Midwestern United States
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>43.42
<p style="margin-left: 0px"><strong>longitude: </strong>-89.73
<p style="margin-left: 0px"><strong>elevation: </strong>293
<p style="margin-left: 0px"><strong>siteName: </strong>Devils Lake
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RznOXTMWx2X
...
<p style="margin-left: 10px"><strong>TSid: </strong>RiNZC42FccO
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD6e4ccc39
