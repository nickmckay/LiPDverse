...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Mjauvotn.Olsen.2010.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Mjauvotn.Olsen.2010.lpd)
            

[Download paleoData only (csv)](Mjauvotn.Olsen.2010.csv)
            

[Download chronData only (csv)](Mjauvotn.Olsen.2010-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Olsen, Jesper"), list(name = "Bjoerck, Svante"), list(name = "Leng, Melanie J."), list(name = "Gudmundsdottir, Esther Ruth"), list(name = "Odgaard, Bent V."), list(name = "Lutz, Christina M."), list(name = "Kendrick, Chris P."), list(name = "Andersen, Thorbjoern J."), list(name = "Seidenkrantz, Marit-Solveig"))
<p style="margin-left: 10px"><strong>citeKey: </strong>olsen2010lacustrineevidenceofholoc
...
<p style="margin-left: 10px"><strong>pages: </strong>2764-2780
<p style="margin-left: 10px"><strong>title: </strong>Lacustrine evidence of Holocene environmental change from three Faroese lakes: a multiproxy XRF and stable isotope study
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>62.12
<p style="margin-left: 0px"><strong>longitude: </strong>-7
<p style="margin-left: 0px"><strong>elevation: </strong>200
<p style="margin-left: 0px"><strong>siteName: </strong>mjauvotn
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RGhpfjIIh4N
...
<p style="margin-left: 10px"><strong>TSid: </strong>R9EYDtOAE15
...
<p style="margin-left: 10px"><strong>TSid: </strong>GH28c9a9bd
...
<p style="margin-left: 20px"><strong>variable: </strong>TM
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTB18QANI2
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>mm
</details>
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTQOD56171
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>d13C (permil)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT5GSFKKDZ
<p style="margin-left: 10px"><strong>variableName: </strong>d13C
<p style="margin-left: 10px"><strong>units: </strong>permil
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTPEY034TK
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (1s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTG0JIQTWZ
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTY6AI49QW
