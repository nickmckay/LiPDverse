...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](KR02.Peros.2008.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/KR02.Peros.2008.lpd)
            

[Download paleoData only (csv)](KR02.Peros.2008.csv)
            

[Download chronData only (csv)](KR02.Peros.2008-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Peros, Matthew C."), list(name = "Gajewski, Konrad"))
...
<p style="margin-left: 10px"><strong>title: </strong>Holocene climate and vegetation change on Victoria Island, western Canadian Arctic
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8QR5DF8O
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTMIDJIH0O
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>BSi (percent) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJF2ANYG5
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT4WXYNR4X
<p style="margin-left: 10px"><strong>variableName: </strong>OM
<p style="margin-left: 10px"><strong>units: </strong>percent
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>carbonate (percent) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT6IVMD1CC
<p style="margin-left: 10px"><strong>variableName: </strong>carbonate
<p style="margin-left: 10px"><strong>units: </strong>percent
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>MS (si) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT2G7VYZO5
<p style="margin-left: 10px"><strong>variableName: </strong>MS
<p style="margin-left: 10px"><strong>units: </strong>si
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>depth (cm) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTTJ5QELH2
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTF0ZLTLNQ
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTAQLF5M5B
...
<details style="margin-left: 10px">
<summary>precipitation (missing) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT4D9VTHOK
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT5X159BOZ
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTNU3CCCBS
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTE65K43LH
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTBIYJ3X05
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTWXZZ235I
