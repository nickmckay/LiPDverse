...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](kusawa.Chakraborty.2010.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/kusawa.Chakraborty.2010.lpd)
            

[Download paleoData only (csv)](kusawa.Chakraborty.2010.csv)
            

[Download chronData only (csv)](kusawa.Chakraborty.2010-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Chakraborty, Krish"), list(name = "Finkelstein, Sarah A."), list(name = "Desloges, Joseph R."), list(name = "Chow, Nicole A."))
<p style="margin-left: 10px"><strong>journal: </strong>Quaternary Research
<p style="margin-left: 10px"><strong>volume: </strong>74
<p style="margin-left: 10px"><strong>title: </strong>Holocene paleoenvironmental changes inferred from diatom assemblages in sediments of Kusawa Lake, Yukon Territory, Canada
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>60.275
<p style="margin-left: 0px"><strong>longitude: </strong>-136.182
<p style="margin-left: 0px"><strong>elevation: </strong>671
<p style="margin-left: 0px"><strong>siteName: </strong>kusawa
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT3ZO4IKKE
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT36SDN548
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>BSi (percent)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8QV5B55C
...
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTDNXPHVKU
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJNXIRLV9
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age14C (bp)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT3U3IP39I
<p style="margin-left: 10px"><strong>variableName: </strong>age14C
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>age_error (years)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTRCCLYVI6
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT7L7NQL0K
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTA6U55ZSR
<p style="margin-left: 10px"><strong>variableName: </strong>cal_age_range_old
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>cal_age_range_young (2_s)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTG7EUZW5V
