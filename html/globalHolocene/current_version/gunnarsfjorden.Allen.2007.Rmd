---
title: "gunnarsfjorden.Allen.2007"
output: 
...
```
#gunnarsfjorden.Allen.2007

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](gunnarsfjorden.Allen.2007.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/gunnarsfjorden.Allen.2007.lpd)
            

[Download paleoData only (csv)](gunnarsfjorden.Allen.2007.csv)
            

[Download chronData only (csv)](gunnarsfjorden.Allen.2007-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Allen, Judy R.M."), list(name = "Long, Antony J."), list(name = "Ottley, Chris J."), list(name = "Graham Pearson, D."), list(name = "Huntley, Brian"))
...
<p style="margin-left: 10px"><strong>title: </strong>Holocene climate variability in northernmost Europe
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>71.0383
<p style="margin-left: 0px"><strong>longitude: </strong>28.1685
<p style="margin-left: 0px"><strong>elevation: </strong>78
<p style="margin-left: 0px"><strong>siteName: </strong>gunnarsfjorden
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTUOT8LV04
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTGONMO5U7
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>precipitation (mm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTU06V9X6E
...
<details style="margin-left: 10px">
<summary>dD (sum deg c) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT7QTLPRRU
<p style="margin-left: 10px"><strong>variableName: </strong>dD
<p style="margin-left: 10px"><strong>units: </strong>sum deg c
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
<details>
<summary>interpretation</summary>
<details style="margin-left: 20px">
...
<p style="margin-left: 20px"><strong>scope: </strong>climate
<p style="margin-left: 20px"><strong>seasonality: </strong>Summer
<p style="margin-left: 20px"><strong>variable: </strong>GDD
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTE08I3BN3
...
<details style="margin-left: 10px">
<summary>AET/PET (missing) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT69UB9SYQ
<p style="margin-left: 10px"><strong>variableName: </strong>AET/PET
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTLZ4AEUT4
<p style="margin-left: 10px"><strong>variableName: </strong>sampleID
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>error (1s) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTP0NRWRTW
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTL5CFY16M
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHEC2VIP4
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 20px"><strong>interpDirection: </strong>1
<p style="margin-left: 20px"><strong>scope: </strong>climate
<p style="margin-left: 20px"><strong>seasonality: </strong>COLDEST+WARMEST
<p style="margin-left: 20px"><strong>variable: </strong>T
<p style="margin-left: 20px"><strong>variableDetail: </strong>air@surface
</details>
</details>
