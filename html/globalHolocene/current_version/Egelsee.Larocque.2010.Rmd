...
```
#Egelsee.Larocque.2010

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Egelsee.Larocque.2010.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/Egelsee.Larocque.2010.lpd)
            

[Download paleoData only (csv)](Egelsee.Larocque.2010.csv)
            

[Download chronData only (csv)](Egelsee.Larocque.2010-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Larocque-Tobler, Isabelle"), list(name = "Heiri, Oliver"), list(name = "Wehrli, Michael"))
<p style="margin-left: 10px"><strong>journal: </strong>Journal of Paleolimnology
<p style="margin-left: 10px"><strong>volume: </strong>43
<p style="margin-left: 10px"><strong>title: </strong>Late Glacial and Holocene temperature changes at Egelsee, Switzerland, reconstructed using subfossil chironomids
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>47.18
<p style="margin-left: 0px"><strong>longitude: </strong>8.58
<p style="margin-left: 0px"><strong>elevation: </strong>770
<p style="margin-left: 0px"><strong>siteName: </strong>Egelsee
...
<p style="margin-left: 10px"><strong>TSid: </strong>RpZgANhnXQg
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RuDlpITZlOw
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RHkrEHLrEmG
...
<p style="margin-left: 10px"><strong>TSid: </strong>RchUIrrkpoo
...
<details style="margin-left: 10px">
<summary>UnkownColumn (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RE1SFzy4szt
<p style="margin-left: 10px"><strong>variableName: </strong>UnkownColumn
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RZiMirbLNCu
...
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>Rx4lRglHxl5
<p style="margin-left: 10px"><strong>variableName: </strong>uncertainty
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>RhOy3HwnG3Y
