---
title: "JR01.Fortin&Gajewski.2017"
output: 
...
```
#JR01.Fortin&Gajewski.2017

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](JR01.Fortin&Gajewski.2017.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/JR01.Fortin&Gajewski.2017.lpd)
            

[Download paleoData only (csv)](JR01.Fortin&Gajewski.2017.csv)
            

[Download chronData only (csv)](JR01.Fortin&Gajewski.2017-chron.csv)
...
<p style="margin-left: 10px"><strong>volume: </strong>85
<p style="margin-left: 10px"><strong>title: </strong>Multiproxy paleoecological evidence of Holocene climatic changes on the Boothia Peninsula, Canadian Arctic
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>TSid: </strong>Rgxi4QgvKRz
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RckFvc0ubXz
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RhF20RCQseU
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>combined SST and salinity
...
<p style="margin-left: 10px"><strong>TSid: </strong>RTD4wvv9taR
...
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RpEy6q0ZesU
<p style="margin-left: 10px"><strong>variableName: </strong>uncertainty
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>RE9U8NtLkbg
