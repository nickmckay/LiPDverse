...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](N14..2004.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/N14..2004.lpd)
            

[Download paleoData only (csv)](N14..2004.csv)
            

[Download chronData only (csv)](N14..2004-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Andresen, Camilla S."), list(name = "Bjoerck, Svante"), list(name = "Bennike, Ole"), list(name = "Bond, Gerard"))
<p style="margin-left: 10px"><strong>citeKey: </strong>andresen2004holoceneclimatechangesins
...
<p style="margin-left: 10px"><strong>pages: </strong>783-795
<p style="margin-left: 10px"><strong>title: </strong>Holocene climate changes in southern Greenland: evidence from lake sediments
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>59.98
<p style="margin-left: 0px"><strong>longitude: </strong>-44.18
<p style="margin-left: 0px"><strong>elevation: </strong>101
<p style="margin-left: 0px"><strong>siteName: </strong>N14
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>year (AD)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>R8E7se4Opkg
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ri0PTHt0ErU
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
<p style="margin-left: 10px"><strong>description: </strong>Years before present (1950) BP
</details>
<details style="margin-left: 10px">
<summary>BSi (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>GH77108454
...
<p style="margin-left: 20px"><strong>variableDetail: </strong>P all
</details>
</details>
</details>
<details>
