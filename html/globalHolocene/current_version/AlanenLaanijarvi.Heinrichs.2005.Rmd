---
title: "AlanenLaanijarvi.Heinrichs.2005"
output: 
...
```
#AlanenLaanijarvi.Heinrichs.2005

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](AlanenLaanijarvi.Heinrichs.2005.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/AlanenLaanijarvi.Heinrichs.2005.lpd)
            

[Download paleoData only (csv)](AlanenLaanijarvi.Heinrichs.2005.csv)
            

[Download chronData only (csv)](AlanenLaanijarvi.Heinrichs.2005-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Heinrichs, Markus"), list(name = "Peglar, Sylvia"), list(name = "Bigler, Christian"), list(name = "Birks, H"))
<p style="margin-left: 10px"><strong>journal: </strong>Boreas
<p style="margin-left: 10px"><strong>volume: </strong>34
<p style="margin-left: 10px"><strong>title: </strong>A multi-proxy palaeoecological study of Alanen Laanijärvi, a boreal-forest lake in Swedish Lapland
</details>
<details style="margin-left: 10px">
...
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>67.97
<p style="margin-left: 0px"><strong>longitude: </strong>20.48
<p style="margin-left: 0px"><strong>elevation: </strong>365
<p style="margin-left: 0px"><strong>siteName: </strong>Alanen Laanijarvi
...
<p style="margin-left: 10px"><strong>TSid: </strong>RB5TyqMPYuk
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RFtqjORtRdW
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>Ry0uq7BMis9
...
<p style="margin-left: 10px"><strong>TSid: </strong>R2HkffJ85JD
...
<p style="margin-left: 10px"><strong>TSid: </strong>RpANZbbke0R
...
<p style="margin-left: 10px"><strong>TSid: </strong>RbQ8xy5Ca4l
...
<details style="margin-left: 10px">
<summary>uncertainty (missing)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>RhfDXHC3UTf
<p style="margin-left: 10px"><strong>variableName: </strong>uncertainty
<p style="margin-left: 10px"><strong>units: </strong>missing
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>RGGiPlqVWGy
