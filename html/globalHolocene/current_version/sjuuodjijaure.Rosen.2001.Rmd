---
title: "sjuuodjijaure.Rosen.2001"
output: 
...
```
#sjuuodjijaure.Rosen.2001

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](sjuuodjijaure.Rosen.2001.lpd)
            

[Edit LiPD file](http://lipd.net/playground?source=http://lipdverse.org/globalHolocene/0_25_5/sjuuodjijaure.Rosen.2001.lpd)
            

[Download paleoData only (csv)](sjuuodjijaure.Rosen.2001.csv)
            

[Download chronData only (csv)](sjuuodjijaure.Rosen.2001-chron.csv)
...
<p style="margin-left: 10px"><strong>author: </strong>list(list(name = "Rosen, Peter"), list(name = "Segerstrom, Ulf"), list(name = "Eriksson, Lars"), list(name = "Renberg, Ingemar"), list(name = "Birks, H. J.B."))
<p style="margin-left: 10px"><strong>journal: </strong>The Holocene
<p style="margin-left: 10px"><strong>volume: </strong>11
<p style="margin-left: 10px"><strong>pages: </strong>551-562
<p style="margin-left: 10px"><strong>title: </strong>Holocene climatic change reconstructed from diatoms, chironomids, pollen and                 near-infrared spectroscopy at an alpine lake (Sjuodjijaure) in northern Sweden
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 0px"><strong>elevation: </strong>826
<p style="margin-left: 0px"><strong>siteName: </strong>sjuuodjijaure
</details>
<details open>
<summary>PaleoData columns</summary>
<details style="margin-left: 10px">
<summary>depth (cm) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTLGCB28FF
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTOXKPMFZP
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [1-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTTYZNWOYL
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTANNMCL5Q
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>age (BP) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTHZQPVBWR
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [2-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTN99W834C
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>TRUE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTR1KEP22A
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [2-2]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTQBB7JT6P
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT09CI1MWW
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>BP
</details>
<details style="margin-left: 10px">
<summary>depth (cm) [3-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT6EK1N8OY
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>temperature (degC) [3-1]</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT4HOSEYKO
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>TRUE
<details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYT8EFWQUL7
<p style="margin-left: 10px"><strong>variableName: </strong>age
<p style="margin-left: 10px"><strong>units: </strong>bp
</details>
<details style="margin-left: 10px">
<summary>depth (cm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTUDVWE9Z5
<p style="margin-left: 10px"><strong>variableName: </strong>depth
<p style="margin-left: 10px"><strong>units: </strong>cm
</details>
<details style="margin-left: 10px">
<summary>depth_bot (mm)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYT1CFK6WGM
...
<p style="margin-left: 10px"><strong>TSid: </strong>PYTFXTHDR34
<p style="margin-left: 10px"><strong>variableName: </strong>material_dated
<p style="margin-left: 10px"><strong>units: </strong>unitless
</details>
<details style="margin-left: 10px">
<summary>note (unitless)</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>PYTJX507LJO
