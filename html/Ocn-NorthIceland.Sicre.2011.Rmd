---
title: "Ocn-NorthIceland.Sicre.2011"
output: 
...
```
#Ocn-NorthIceland.Sicre.2011

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-NorthIceland.Sicre.2011.lpd)
...
<p style="margin-left: 10px"><strong>pages: </strong>PA4218
...
<p style="margin-left: 0px"><strong>longitude: </strong>-17.42
<p style="margin-left: 0px"><strong>elevation: </strong>-470
<p style="margin-left: 0px"><strong>siteName: </strong>North Iceland/North Atlantic
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_045
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_046
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
