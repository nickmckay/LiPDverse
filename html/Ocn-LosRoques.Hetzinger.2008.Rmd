---
title: "Ocn-LosRoques.Hetzinger.2008"
output: 
...
```
#Ocn-LosRoques.Hetzinger.2008

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-LosRoques.Hetzinger.2008.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Hetzinger, Steffen;Pfeiffer, Miriam;Dullo, Wolf-Christian;Keenlyside, Noel;Latif, Mojib;Zinke, Jens
<p style="margin-left: 10px"><strong>citeKey: </strong>hetzinger2008caribbeancoraltracksatlan
<p style="margin-left: 10px"><strong>journal: </strong>Geology
<p style="margin-left: 10px"><strong>volume: </strong>36
<p style="margin-left: 10px"><strong>pages: </strong>11-14
...
<p style="margin-left: 10px"><strong>citeKey: </strong>hetzinger2012httpswwwncdcnoaagovpaleostudy12891DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Los Roques, Venezuela
