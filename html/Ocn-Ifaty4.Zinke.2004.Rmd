...
```
#Ocn-Ifaty4.Zinke.2004

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Ifaty4.Zinke.2004.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Zinke, J.;Dullo, W.-Chr.;Heiss, G.A.;Eisenhauer, A.
<p style="margin-left: 10px"><strong>citeKey: </strong>zinke2004ensoandindianoceansubtrop
...
<p style="margin-left: 10px"><strong>pages: </strong>177-194
...
<p style="margin-left: 10px"><strong>DOI: </strong>10.1016/j.epsl.2004.09.028
</details>
<details style="margin-left: 10px">
