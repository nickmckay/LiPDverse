---
title: "Ocn-NorthEastBreakers_Bermuda.Kuhnert.2005"
output: 
...
```
#Ocn-NorthEastBreakers_Bermuda.Kuhnert.2005

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-NorthEastBreakers_Bermuda.Kuhnert.2005.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Kuhnert, Henning;Crüger, Traute;Pätzold, Jürgen
<p style="margin-left: 10px"><strong>citeKey: </strong>kuhnert2005naosignatureinabermudacor
...
<p style="margin-left: 10px"><strong>pages: </strong>Q04004
...
<p style="margin-left: 10px"><strong>citeKey: </strong>kuhnert2005httpdoipangaeade101594pangaea738188DataCitation
