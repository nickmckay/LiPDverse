...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-RedSea.Felis.2000.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Felis, Thomas;Pätzold, Jürgen;Loya, Yossi;Fine, Maoz;Nawar, Ahmed H.;Wefer, Gerold
<p style="margin-left: 10px"><strong>citeKey: </strong>felis2000acoraloxygenisotoperecord
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>15
<p style="margin-left: 10px"><strong>pages: </strong>679-694
...
<p style="margin-left: 10px"><strong>citeKey: </strong>felis2000httpswwwncdcnoaagovpaleostudy1861DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Red Sea
