---
title: "Ocn-HoutmanAbrolhosHAB05B.Zinke.2014"
output: 
...
```
#Ocn-HoutmanAbrolhosHAB05B.Zinke.2014

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-HoutmanAbrolhosHAB05B.Zinke.2014.lpd)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>zinke2014coralsrecordlongtermleeuw
<p style="margin-left: 10px"><strong>journal: </strong>Nature Communications
<p style="margin-left: 10px"><strong>volume: </strong>5
<p style="margin-left: 10px"><strong>pages: </strong>4607
<p style="margin-left: 10px"><strong>pubYear: </strong>2014
<p style="margin-left: 10px"><strong>title: </strong>Corals record long-term Leeuwin current variability including Ningaloo Niño/Niña since 1795
<p style="margin-left: 10px"><strong>DOI: </strong>10.1038/ncomms4607
</details>
<details style="margin-left: 10px">
<summary>pub2</summary>
<p style="margin-left: 10px"><strong>author: </strong>Zinke, J.
<p style="margin-left: 10px"><strong>citeKey: </strong>zinke2014httpswwwncdcnoaagovpaleostudy16316DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-28.4609
<p style="margin-left: 0px"><strong>longitude: </strong>113.772
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_025
