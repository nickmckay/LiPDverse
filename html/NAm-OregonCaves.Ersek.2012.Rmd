---
title: "NAm-OregonCaves.Ersek.2012"
output: 
...
```
#NAm-OregonCaves.Ersek.2012

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](NAm-OregonCaves.Ersek.2012.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Ersek, Vasile;Clark, Peter U.;Mix, Alan C.;Cheng, Hai;Lawrence Edwards, R.
...
<p style="margin-left: 10px"><strong>citeKey: </strong>ersek2012httpswwwncdcnoaagovpaleostudy13543DataCitation
...
<p style="margin-left: 0px"><strong>siteName: </strong>Oregon Caves National Monument
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_3870
