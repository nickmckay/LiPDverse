...
```
#Ocn-Rabaul.Quinn.2006

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Rabaul.Quinn.2006.lpd)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>quinn2006coralbasedclimatevariabil
<p style="margin-left: 10px"><strong>journal: </strong>Joural of Geophysical Research
<p style="margin-left: 10px"><strong>volume: </strong>111
<p style="margin-left: 10px"><strong>pages: </strong>C11006
...
<p style="margin-left: 10px"><strong>citeKey: </strong>quinn2008httpswwwncdcnoaagovpaleostudy6116DataCitation
