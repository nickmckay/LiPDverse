---
title: "Ocn-AbrahamReef.Druffel.1999"
output: 
...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-AbrahamReef.Druffel.1999.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>ftp://ftp.ncdc.noaa.gov/pub/data/paleo/coral/west_pacific/great_barrier/abraham1999iso.txt
...
<p style="margin-left: 10px"><strong>author: </strong>Druffel, Ellen R. M.;Griffin, Sheila
<p style="margin-left: 10px"><strong>citeKey: </strong>druffel1999variabilityofsurfaceocean
...
<p style="margin-left: 10px"><strong>pages: </strong>23607-23613
<p style="margin-left: 10px"><strong>pubYear: </strong>1999
<p style="margin-left: 10px"><strong>title: </strong>Variability of surface ocean radiocarbon and stable isotopes in the southwestern Pacific
...
<p style="margin-left: 10px"><strong>author: </strong>Druffel, E.R.M.
<p style="margin-left: 10px"><strong>citeKey: </strong>druffel2004httpswwwncdcnoaagovpaleostudy1911DataCitation
...
<p style="margin-left: 0px"><strong>elevation: </strong>-2.5
<p style="margin-left: 0px"><strong>siteName: </strong>Abraham Reef
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_167
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_168
