---
title: "Ocn-Nauru.Guilderson.1999"
output: 
...
```
#Ocn-Nauru.Guilderson.1999

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Nauru.Guilderson.1999.lpd)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>guilderson1999reliabilityofcoralisotope
<p style="margin-left: 10px"><strong>journal: </strong>Paleoceanography
<p style="margin-left: 10px"><strong>volume: </strong>14
<p style="margin-left: 10px"><strong>pages: </strong>457-464
...
<p style="margin-left: 10px"><strong>author: </strong>Guilderson, T.P.
<p style="margin-left: 10px"><strong>citeKey: </strong>guilderson1999httpswwwncdcnoaagovpaleostudy1842DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-0.53296
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_179
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_180
