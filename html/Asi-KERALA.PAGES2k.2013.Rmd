...
```
#Asi-KERALA.PAGES2k.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-KERALA.PAGES2k.2013.lpd)
...
<p style="margin-left: 0px"><strong>longitude: </strong>76.67
<p style="margin-left: 0px"><strong>elevation: </strong>3100
<p style="margin-left: 0px"><strong>siteName: </strong>KERALA
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_106
