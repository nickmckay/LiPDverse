...
```
#Asi-CHIN039.Fan.2013

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Asi-CHIN039.Fan.2013.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/14908
...
<p style="margin-left: 10px"><strong>author: </strong>Fan, Z.X.
<p style="margin-left: 10px"><strong>citeKey: </strong>fan2013httpswwwncdcnoaagovpaleostudy14908DataCitation
...
<p style="margin-left: 0px"><strong>longitude: </strong>99.02
<p style="margin-left: 0px"><strong>elevation: </strong>3400
<p style="margin-left: 0px"><strong>siteName: </strong>CHIN039
...
<p style="margin-left: 10px"><strong>TSid: </strong>Asia_081
