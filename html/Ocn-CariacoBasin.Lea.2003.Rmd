---
title: "Ocn-CariacoBasin.Lea.2003"
output: 
...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-CariacoBasin.Lea.2003.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>http://hurricane.ncdc.noaa.gov/pls/paleox/f?p=519:1:2567749405070175::::P1_STUDY_ID:2585
...
<p style="margin-left: 10px"><strong>author: </strong>Lea, D. W.
...
<p style="margin-left: 10px"><strong>DOI: </strong>10.1126/science.1088470
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>author: </strong>Lea, D.W.
<p style="margin-left: 10px"><strong>citeKey: </strong>lea2003httpswwwncdcnoaagovpaleostudy2585DataCitation
...
<p style="margin-left: 10px"><strong>grant: </strong>OCE-0117886
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
...
<p style="margin-left: 0px"><strong>siteName: </strong>Cariaco Basin/Southern Caribbean Sea
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPDcda1c277
...
<details style="margin-left: 10px">
<summary>temperature</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPD806644b2
<p style="margin-left: 10px"><strong>variableName: </strong>temperature
<p style="margin-left: 10px"><strong>units: </strong>degC
<p style="margin-left: 10px"><strong>description: </strong>inferred sea-surface temperature
...
<p style="margin-left: 10px"><strong>TSid: </strong>LPD0e9a7a86
<p style="margin-left: 10px"><strong>variableName: </strong>notes
<p style="margin-left: 10px"><strong>description: </strong>quality-controlled data from Lea et al. (2003) that was used in the O2K-LR analysis
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>Mg_Ca</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>LPDc55a0cae
<p style="margin-left: 10px"><strong>variableName: </strong>Mg_Ca
<p style="margin-left: 10px"><strong>description: </strong>native Mg/Ca ratio that was used to calculate SST
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
