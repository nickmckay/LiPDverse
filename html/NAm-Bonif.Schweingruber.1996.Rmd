---
title: "NAm-Bonif.Schweingruber.1996"
output: 
...
```
#NAm-Bonif.Schweingruber.1996

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](NAm-Bonif.Schweingruber.1996.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/4349
...
<p style="margin-left: 10px"><strong>citeKey: </strong>schweingruber2000httpswwwncdcnoaagovpaleostudy4349DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>55.3
<p style="margin-left: 0px"><strong>longitude: </strong>-77.8
<p style="margin-left: 0px"><strong>elevation: </strong>50
<p style="margin-left: 0px"><strong>siteName: </strong>Bonif  historisc
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1432
...
<details style="margin-left: 10px">
<summary>MXD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1444
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1429
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1430
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1431
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1433
...
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1434
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1435
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1436
...
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1437
...
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1438
...
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1439
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1440
...
<details style="margin-left: 10px">
<summary>sampleCount</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1441
<p style="margin-left: 10px"><strong>variableName: </strong>sampleCount
<p style="margin-left: 10px"><strong>units: </strong>count
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>segment</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1442
<p style="margin-left: 10px"><strong>variableName: </strong>segment
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
...
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1443
...
<details style="margin-left: 10px">
<summary>residual</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1445
<p style="margin-left: 10px"><strong>variableName: </strong>residual
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>ARS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1446
<p style="margin-left: 10px"><strong>variableName: </strong>ARS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>corrs</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1447
<p style="margin-left: 10px"><strong>variableName: </strong>corrs
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>RBar</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1448
<p style="margin-left: 10px"><strong>variableName: </strong>RBar
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SD</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1449
<p style="margin-left: 10px"><strong>variableName: </strong>SD
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>SE</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1450
<p style="margin-left: 10px"><strong>variableName: </strong>SE
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>EPS</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1451
<p style="margin-left: 10px"><strong>variableName: </strong>EPS
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
<details style="margin-left: 10px">
<summary>core</summary>
<p style="margin-left: 10px"><strong>TSid: </strong>NAm_1452
<p style="margin-left: 10px"><strong>variableName: </strong>core
<p style="margin-left: 10px"><strong>units: </strong>NA
<p style="margin-left: 10px"><strong>useInGlobalTemperatureAnalysis: </strong>FALSE
</details>
