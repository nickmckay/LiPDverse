---
title: "Ocn-Bermuda.DraschbaB.2000"
output: 
...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-Bermuda.DraschbaB.2000.lpd)
...
<p style="margin-left: 10px"><strong>author: </strong>Draschba, S.;Pätzold, J.;Wefer, G.
<p style="margin-left: 10px"><strong>citeKey: </strong>draschba2000northatlanticclimatevaria
...
<p style="margin-left: 10px"><strong>pages: </strong>733-741
<p style="margin-left: 10px"><strong>pubYear: </strong>2000
<p style="margin-left: 10px"><strong>title: </strong>North Atlantic climate variability since AD 1350 recorded in δ 18 O and skeletal density of Bermuda corals
...
<p style="margin-left: 10px"><strong>citeKey: </strong>draschba2000httpdoipangaeade101594pangaea711835DataCitation
<p style="margin-left: 10px"><strong>title: </strong>PANGAEA
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>30.0867
<p style="margin-left: 0px"><strong>longitude: </strong>-64.5417
<p style="margin-left: 0px"><strong>elevation: </strong>-25
<p style="margin-left: 0px"><strong>siteName: </strong>Bermuda
