---
title: "Ocn-EmeraldBasin.Keigwin.2003"
output: 
...
```
#Ocn-EmeraldBasin.Keigwin.2003

Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-EmeraldBasin.Keigwin.2003.lpd)
...
<p style="margin-left: 10px"><strong>citeKey: </strong>keigwin2003a1600yearhistoryofthelabr
<p style="margin-left: 10px"><strong>journal: </strong>Climate Dynamics
<p style="margin-left: 10px"><strong>volume: </strong>21
<p style="margin-left: 10px"><strong>pages: </strong>53-62
...
<p style="margin-left: 10px"><strong>citeKey: </strong>keigwin2011httpswwwncdcnoaagovpaleostudy10891DataCitation
...
<p style="margin-left: 10px"><strong>TSid: </strong>O2kLR_074
