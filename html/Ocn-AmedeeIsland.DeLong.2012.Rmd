---
title: "Ocn-AmedeeIsland.DeLong.2012"
output: 
...
Metadata {.sidebar}
-------------------------------------
[Download LiPD file](Ocn-AmedeeIsland.DeLong.2012.lpd)
...
<p style="margin-left: 0px"><strong>originalDataURL: </strong>https://www.ncdc.noaa.gov/paleo/study/13035
...
<p style="margin-left: 10px"><strong>author: </strong>DeLong, Kristine L.;Quinn, Terrence M.;Taylor, Frederick W.;Lin, Ke;Shen, Chuan-Chou
<p style="margin-left: 10px"><strong>citeKey: </strong>delong2012seasurfacetemperaturevari
<p style="margin-left: 10px"><strong>journal: </strong>Nature Climate Change
<p style="margin-left: 10px"><strong>volume: </strong>2
<p style="margin-left: 10px"><strong>pages: </strong>799-804
<p style="margin-left: 10px"><strong>pubYear: </strong>2012
<p style="margin-left: 10px"><strong>title: </strong>Sea surface temperature variability in the southwest tropical Pacific since AD 1649
<p style="margin-left: 10px"><strong>DOI: </strong>10.1038/nclimate1583
</details>
<details style="margin-left: 10px">
...
<p style="margin-left: 10px"><strong>citeKey: </strong>delong2012httpswwwncdcnoaagovpaleostudy13035DataCitation
<p style="margin-left: 10px"><strong>title: </strong>World Data Center for Paleoclimatology
</details>
</details>
<details open style="margin-left: 0px">
<summary>geo</summary>
<p style="margin-left: 0px"><strong>latitude: </strong>-22.475
<p style="margin-left: 0px"><strong>longitude: </strong>166.4667
<p style="margin-left: 0px"><strong>elevation: </strong>-3
<p style="margin-left: 0px"><strong>siteName: </strong>Amedee Island
...
<p style="margin-left: 10px"><strong>TSid: </strong>Ocean2kHR_134
